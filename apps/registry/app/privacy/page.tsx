      ...
      <div className="max-w-3xl mx-auto">
        ...
        <Card className="mb-8">
          <CardContent className="p-6 prose prose-gray max-w-none">
            ...
            <p>
              Your resume data is stored in GitHub Gists under your control. We
              do not maintain a separate database of resume content.
              Authentication is handled securely through GitHub's OAuth system.
            </p>
            ...
            <p>
              ...
              you are under 13, please do not use our service or provide any
              personal information.
            </p>
