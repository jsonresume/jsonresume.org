...
import { PrivacyHeader, PrivacySection, ContactFooter } from './components';
          ...
          <CardContent className="p-6 prose prose-gray max-w-none">
            <PrivacySection number="1" title="Information We Collect">
              ...
              <ul className="list-disc pl-6 mt-2">
                <li>
                  GitHub authentication data (when you sign in with GitHub)
                </li>
            ...
            <PrivacySection number="3" title="Data Storage and Security">
              <p>
                Your resume data is stored in GitHub Gists under your control.
                We do not maintain a separate database of resume content.
                Authentication is handled securely through GitHub's OAuth
                system.
              </p>
            </PrivacySection>
            ...
            <PrivacySection number="4" title="Data Sharing">
              <p>
                ...
                parties. Your resume data is public or private according to your
                GitHub Gist settings. We recommend reviewing your GitHub privacy
                settings to ensure your resume data is shared according to your
                preferences.
              </p>
            </PrivacySection>
            ...
            <PrivacySection number="5" title="Cookies and Tracking">
              <p>
                We use minimal cookies necessary for authentication and basic
                site functionality. We may use basic analytics to understand
                site usage patterns, but we do not track individual users or
            ...
            <PrivacySection number="7" title="Children's Privacy">
              <p>
                ...
                If you are under 13, please do not use our service or provide
