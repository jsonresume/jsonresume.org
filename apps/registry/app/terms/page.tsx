      ...
      <div className="max-w-3xl mx-auto">
        ...
        <Card className="mb-8">
          <CardContent className="p-6 prose prose-gray max-w-none">
            ...
            <p>
              JSON Resume is an open-source project. The source code is available under the MIT license. 
            ...
            <p>
              JSON Resume is provided "as is", without warranty of any kind, express or implied. 
            ...
            <p>
              In no event shall JSON Resume or its contributors be liable for any damages arising out of 
              the use or inability to use the service. This includes but is not limited to damages for 
              loss of data or profit, or due to business interruption.
            </p>

            <h2 className="text-2xl font-semibold mb-4 mt-8">5. User Content</h2>
            <p>
              When you create or make available your resume through JSON Resume, you represent that:
            </p>
            <ul className="list-disc pl-6 mt-2">
              <li>The creation and use of your content doesn't violate any applicable laws</li>
            ...
            <h2 className="text-2xl font-semibold mb-4 mt-8">6. Service Modifications</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold mb-4 mt-8">7. Governing Law</h2>
            <p>
              These terms shall be governed by and construed in accordance with the laws of the 
              jurisdiction in which the project maintainers reside, without regard to its conflict 
              of law provisions.
            </p>
