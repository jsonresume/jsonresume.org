          ...
          <CardContent className="relative pt-20 pb-20">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-gray-300 mb-12 max-w-2xl mx-auto text-lg leading-relaxed">
                Create a beautiful, standardized resume that you can version control, share, and maintain like code. 
                Perfect for developers who take pride in their craft.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Button size="lg" className="gap-2 text-lg h-14 px-8 hover:scale-105 transition-transform w-full sm:w-auto bg-white text-gray-900 hover:bg-white/90" asChild>
                  <Link href="/login">
                    <Github className="w-5 h-5" />
                ...
                <Button size="lg" variant="outline" className="gap-2 text-lg h-14 px-8 hover:scale-105 transition-transform w-full sm:w-auto border-white/20 hover:bg-white/10 backdrop-blur-xl" asChild>
                  <a href="https://jsonresume.org/schema" target="_blank" rel="noopener noreferrer">
                    <FileJson className="w-5 h-5" />
                    Explore the Schema
                  </a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <div className="flex gap-4">
                <a href="https://github.com/jsonresume" target="_blank" rel="noopener noreferrer" 
                   className="text-gray-600 hover:text-gray-900 transition-colors">
                  <Github className="w-5 h-5" />
                </a>
                <a href="https://twitter.com/jsonresume" target="_blank" rel="noopener noreferrer"
                   className="text-gray-600 hover:text-gray-900 transition-colors">
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                  </svg>
                </a>
                <a href="https://discord.gg/jsonresume" target="_blank" rel="noopener noreferrer"
                   className="text-gray-600 hover:text-gray-900 transition-colors">
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="https://jsonresume.org/schema" className="text-gray-600 hover:text-gray-900 transition-colors">Schema</a>
                </li>
                <li>
                  <a href="https://jsonresume.org/themes" className="text-gray-600 hover:text-gray-900 transition-colors">Themes</a>
                </li>
                <li>
                  <a href="https://jsonresume.org/getting-started" className="text-gray-600 hover:text-gray-900 transition-colors">Getting Started</a>
                </li>
                <li>
                  <a href="https://jsonresume.org/api" className="text-gray-600 hover:text-gray-900 transition-colors">API</a>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="https://github.com/jsonresume" className="text-gray-600 hover:text-gray-900 transition-colors">GitHub</a>
                </li>
                <li>
                  <a href="https://discord.gg/jsonresume" className="text-gray-600 hover:text-gray-900 transition-colors">Discord</a>
                </li>
                <li>
                  <a href="https://twitter.com/jsonresume" className="text-gray-600 hover:text-gray-900 transition-colors">Twitter</a>
                </li>
                <li>
                  <a href="https://jsonresume.org/blog" className="text-gray-600 hover:text-gray-900 transition-colors">Blog</a>
                </li>
              </ul>
            </div>
          </div>
          <div className="mt-12 pt-8 border-t border-gray-200">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <p className="text-gray-500 text-sm">
                &copy; {new Date().getFullYear()} JSON Resume. Open source under MIT license.
              </p>
