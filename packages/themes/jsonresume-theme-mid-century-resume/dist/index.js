...
`;
const DecorativeRectangle = dt.div`
  position: absolute;
  bottom: 40px;
  left: 40px;
  width: 60px;
...
function Resume({ resume }) {
  ...
  return /* @__PURE__ */ jsxs(Layout, { children: [
    /* @__PURE__ */ jsx(DecorativeCircle, {}),
    /* @__PURE__ */ jsx(DecorativeRectangle, {}),
...
function render(resume) {
  return renderResumeDocument(/* @__PURE__ */ jsx(Resume, { resume }), {
    fonts: [
      "https://fonts.googleapis.com/css2?family=League+Spartan:wght@400;500;600;700&family=Josefin+Sans:wght@400;500;600;700&display=swap"
    ],
