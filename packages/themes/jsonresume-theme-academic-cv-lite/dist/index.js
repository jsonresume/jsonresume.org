...
`;
const PublicationTitle = dt.span`
  font-weight: 700;
  color: #111827;
`;
const PublicationMeta = dt.span`
  color: #1f2937;
  font-style: italic;
`;
const PublicationDate = dt.span`
  color: #6b7280;
`;
...
`;
const AwardTitle = dt.h3`
  font-size: 13pt;
  font-weight: 700;
  color: #111827;
  margin: 0 0 4px 0;
`;
const AwardAwarder = dt.div`
  font-size: 11pt;
  color: #1f2937;
  font-style: italic;
  margin-bottom: 4px;
`;
const AwardDate = dt.div`
  font-size: 11pt;
  color: #6b7280;
  margin-bottom: 8px;
`;
const AwardSummary = dt.p`
  margin: 0;
  font-size: 11pt;
  color: #1f2937;
  line-height: 1.5;
...
const SkillItem = dt.div`
  ...
  gap: 8px;
`;
const SkillName = dt.span`
  font-weight: 700;
  color: #111827;
  font-size: 12pt;
  min-width: 120px;
`;
const SkillKeywords = dt.span`
  color: #1f2937;
  font-size: 11pt;
`;
function Resume({ resume }) {
  ...
  return /* @__PURE__ */ jsxs(Layout, { children: [
    ...
    publications?.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
      ...
      publications.map((pub, index) => /* @__PURE__ */ jsxs(PublicationItem, { children: [
        /* @__PURE__ */ jsxs(PublicationTitle, { children: [
          pub.name,
          ". "
        ] }),
        pub.publisher && /* @__PURE__ */ jsxs(PublicationMeta, { children: [
          pub.publisher,
          ". "
        ] }),
        pub.releaseDate && /* @__PURE__ */ jsxs(PublicationDate, { children: [
          "(",
          pub.releaseDate,
          ")"
        ] }),
    ...
    awards?.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
      ...
      awards.map((award, index) => /* @__PURE__ */ jsxs(AwardItem, { children: [
        ...
        award.awarder && /* @__PURE__ */ jsx(AwardAwarder, { children: award.awarder }),
        award.date && /* @__PURE__ */ jsx(AwardDate, { children: award.date }),
        award.summary && /* @__PURE__ */ jsx(AwardSummary, { children: award.summary })
      ] }, index))
    ] }),
    ...
    projects?.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Research Projects" }),
    ...
    skills?.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
      ...
      /* @__PURE__ */ jsx(SkillsList, { children: skills.map((skill, index) => /* @__PURE__ */ jsxs(SkillItem, { children: [
        /* @__PURE__ */ jsxs(SkillName, { children: [
          skill.name,
          ":"
        ] }),
        skill.keywords?.length > 0 && /* @__PURE__ */ jsx(SkillKeywords, { children: skill.keywords.join(", ") })
      ] }, index)) })
    ] }),
    volunteer?.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Service & Leadership" }),
    ...
    languages?.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
      ...
      /* @__PURE__ */ jsx(SkillsList, { children: languages.map((lang, index) => /* @__PURE__ */ jsxs(SkillItem, { children: [
        /* @__PURE__ */ jsxs(SkillName, { children: [
          lang.language,
          ":"
        ] }),
        lang.fluency && /* @__PURE__ */ jsx(SkillKeywords, { children: lang.fluency })
      ] }, index)) })
    ] }),
    interests?.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Research Interests" }),
      /* @__PURE__ */ jsx(SkillsList, { children: interests.map((interest, index) => /* @__PURE__ */ jsxs(SkillItem, { children: [
        /* @__PURE__ */ jsx(SkillName, { children: interest.name }),
        interest.keywords?.length > 0 && /* @__PURE__ */ jsx(SkillKeywords, { children: interest.keywords.join(", ") })
      ] }, index)) })
    ] }),
