...
function Resume({ resume }) {
  ...
  return /* @__PURE__ */ jsxs(ResumeContainer, { children: [
    ...
    work && work.length > 0 && /* @__PURE__ */ jsxs(ContentSection, { children: [
    ...
    education && education.length > 0 && /* @__PURE__ */ jsxs(ContentSection, { children: [
      ...
      education.map((edu, index) => /* @__PURE__ */ jsxs(EducationItem, { children: [
        ...
        edu.score && /* @__PURE__ */ jsxs(Description, { children: [
          "GPA: ",
          edu.score
        ] })
      ] }, index))
    ] }),
    skills && skills.length > 0 && /* @__PURE__ */ jsxs(ContentSection, { children: [
    ...
    projects && projects.length > 0 && /* @__PURE__ */ jsxs(ContentSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Projects" }),
      projects.map((project, index) => /* @__PURE__ */ jsxs(ProjectItem, { children: [
        project.name && /* @__PURE__ */ jsx(ProjectName, { children: project.name }),
        project.url && /* @__PURE__ */ jsx(ProjectUrl, { children: /* @__PURE__ */ jsx(
          Link,
          {
    ...
    volunteer && volunteer.length > 0 && /* @__PURE__ */ jsxs(ContentSection, { children: [
    ...
    awards && awards.length > 0 && /* @__PURE__ */ jsxs(ContentSection, { children: [
      ...
      publications.map((pub, index) => /* @__PURE__ */ jsxs(AwardItem, { children: [
        ...
        pub.url && /* @__PURE__ */ jsx(ProjectUrl, { children: /* @__PURE__ */ jsx(
          Link,
          {
            ...
            children: pub.url.replace(/^https?:\/\//, "")
          }
        ) })
      ] }, index))
    ] }),
    languages && languages.length > 0 && /* @__PURE__ */ jsxs(ContentSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Languages" }),
      /* @__PURE__ */ jsx(LanguageList, { children: languages.map((language, index) => /* @__PURE__ */ jsxs(LanguageItem, { children: [
    ...
    interests && interests.length > 0 && /* @__PURE__ */ jsxs(ContentSection, { children: [
      ...
      /* @__PURE__ */ jsx(InterestsList, { children: interests.map((interest, index) => /* @__PURE__ */ jsxs(InterestGroup, { children: [
        /* @__PURE__ */ jsx(InterestTag, { children: interest.name }),
    ...
    references && references.length > 0 && /* @__PURE__ */ jsxs(ContentSection, { children: [
      ...
      references.map((ref, index) => /* @__PURE__ */ jsxs(AwardItem, { children: [
        ref.name && /* @__PURE__ */ jsx(AwardTitle, { children: ref.name }),
