...
function ListItem({
  ...
  return /* @__PURE__ */ jsxs(
    ItemContainer,
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsx(ItemHeader, { className: "resume-item-header", children: /* @__PURE__ */ jsx(ItemTitle, { className: "resume-item-title", children: title }) }),
        subtitle && /* @__PURE__ */ jsx(ItemSubtitle, { className: "resume-item-subtitle", children: subtitle }),
        metaItems.length > 0 && /* @__PURE__ */ jsxs(ItemMeta, { className: "resume-item-meta", children: [
          dateRange && /* @__PURE__ */ jsx("span", { className: "resume-date", children: dateRange }),
          dateRange && location && /* @__PURE__ */ jsx("span", { children: "•" }),
          location && /* @__PURE__ */ jsx("span", { className: "resume-location", children: location })
        ] }),
        description && /* @__PURE__ */ jsx(Description, { className: "resume-description", children: description }),
        highlights.length > 0 && /* @__PURE__ */ jsx(Highlights, { className: "resume-highlights", children: highlights.map((highlight, index2) => /* @__PURE__ */ jsx("li", { children: highlight }, index2)) })
      ]
    }
  );
}
...
function Resume({ resume }) {
  ...
  return /* @__PURE__ */ jsxs(Layout, { children: [
    basics && /* @__PURE__ */ jsxs(Header, { children: [
      ...
      /* @__PURE__ */ jsxs(Contact, { children: [
        basics.email && /* @__PURE__ */ jsx("a", { href: safeUrl(`mailto:${basics.email}`), children: basics.email }),
        basics.phone && /* @__PURE__ */ jsx("span", { children: basics.phone }),
        basics.url && /* @__PURE__ */ jsx(
          "a",
          {
        ...
        basics.location && /* @__PURE__ */ jsx("span", { children: [
        ...
        basics.profiles?.map((profile) => {
          ...
          return profileUrl && /* @__PURE__ */ jsx(
            "a",
            {
              href: profileUrl,
              target: "_blank",
    ...
    work.length > 0 && /* @__PURE__ */ jsxs(Section, { id: "work", children: [
      /* @__PURE__ */ jsx(SectionTitle, { children: "Work Experience" }),
      work.map((job, index2) => /* @__PURE__ */ jsx(
        ListItem,
        {
          title: job.position,
          subtitle: job.name,
          dateRange: job.startDate ? /* @__PURE__ */ jsx(DateRange, { startDate: job.startDate, endDate: job.endDate }) : null,
    ...
    education.length > 0 && /* @__PURE__ */ jsxs(Section, { id: "education", children: [
      /* @__PURE__ */ jsx(SectionTitle, { children: "Education" }),
      education.map((edu, index2) => {
        ...
        return /* @__PURE__ */ jsx(
          ListItem,
          {
            ...
            dateRange: edu.startDate ? /* @__PURE__ */ jsx(
              DateRange,
              {
    ...
    skills.length > 0 && /* @__PURE__ */ jsxs(Section, { id: "skills", children: [
      /* @__PURE__ */ jsx(SectionTitle, { children: "Skills" }),
      skills.map((skillGroup, index2) => /* @__PURE__ */ jsxs(SkillGroup, { children: [
        skillGroup.name && /* @__PURE__ */ jsxs("strong", { children: [
          skillGroup.name,
          ":"
        ] }),
        /* @__PURE__ */ jsx(BadgeList, { items: skillGroup.keywords, variant: "default" })
      ] }, index2))
    ] }),
    projects.length > 0 && /* @__PURE__ */ jsxs(Section, { id: "projects", children: [
      /* @__PURE__ */ jsx(SectionTitle, { children: "Projects" }),
      projects.map((project, index2) => /* @__PURE__ */ jsx(
        ListItem,
        {
          title: project.name,
          dateRange: project.startDate ? /* @__PURE__ */ jsx(
            DateRange,
            {
          ...
          description: /* @__PURE__ */ jsxs(Fragment, { children: [
            project.description,
            project.url && safeUrl(project.url) && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx("br", {}),
              /* @__PURE__ */ jsx(
                "a",
                {
    ...
    volunteer.length > 0 && /* @__PURE__ */ jsxs(Section, { id: "volunteer", children: [
      /* @__PURE__ */ jsx(SectionTitle, { children: "Volunteer Experience" }),
      volunteer.map((vol, index2) => /* @__PURE__ */ jsx(
        ListItem,
        {
          title: vol.position,
          subtitle: vol.organization,
          dateRange: vol.startDate ? /* @__PURE__ */ jsx(DateRange, { startDate: vol.startDate, endDate: vol.endDate }) : null,
    ...
    awards.length > 0 && /* @__PURE__ */ jsxs(Section, { id: "awards", children: [
      /* @__PURE__ */ jsx(SectionTitle, { children: "Awards & Honors" }),
      awards.map((award, index2) => /* @__PURE__ */ jsx(
        ListItem,
        {
          title: award.title,
    ...
    publications.length > 0 && /* @__PURE__ */ jsxs(Section, { id: "publications", children: [
      /* @__PURE__ */ jsx(SectionTitle, { children: "Publications" }),
      publications.map((pub, index2) => /* @__PURE__ */ jsx(
        ListItem,
        {
          title: pub.name,
          ...
          description: /* @__PURE__ */ jsxs(Fragment, { children: [
            pub.summary,
            pub.url && safeUrl(pub.url) && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx("br", {}),
              /* @__PURE__ */ jsx(
                "a",
                {
    ...
    languages.length > 0 && /* @__PURE__ */ jsxs(Section, { id: "languages", children: [
      /* @__PURE__ */ jsx(SectionTitle, { children: "Languages" }),
      languages.map((lang, index2) => /* @__PURE__ */ jsxs("div", { children: [
        lang.language,
        lang.fluency && ` (${lang.fluency})`
      ] }, index2))
    ] }),
    interests.length > 0 && /* @__PURE__ */ jsxs(Section, { id: "interests", children: [
    ...
    references.length > 0 && /* @__PURE__ */ jsxs(Section, { id: "references", children: [
      /* @__PURE__ */ jsx(SectionTitle, { children: "References" }),
      references.map((ref, index2) => /* @__PURE__ */ jsx(
        ListItem,
        {
          title: ref.name,
...
`;
    if (structured) {
      return {
        html: `<!DOCTYPE html>
<html lang="${locale}" dir="${dir}"${theme !== "default" ? ` data-theme="${theme}"` : ""}>
<head>${head}</head>
<body>
  ${bodyHtml}
</body>
