...
`;
const SidebarSectionTitle = dt(SectionTitle)`
  background: #111;
  color: white;
  font-size: 11px;
  font-weight: 900;
  ...
  return /* @__PURE__ */ jsxs(Layout, { children: [
    /* @__PURE__ */ jsxs(Header, { children: [
      ...
      /* @__PURE__ */ jsxs(ContactSection, { children: [
        ...
        basics.location?.city && basics.location?.region && /* @__PURE__ */ jsxs(ContactItem, { children: [
          "LOCATION: ",
        ...
        basics.url && /* @__PURE__ */ jsxs(ContactItem, { children: [
          "WEB: ",
          /* @__PURE__ */ jsx("a", { href: safeUrl(basics.url), children: basics.url })
        ] }),
        basics.profiles?.slice(0, 2).map((profile, index) => /* @__PURE__ */ jsxs(ContactItem, { children: [
          profile.network.toUpperCase(),
          ":",
          " ",
          /* @__PURE__ */ jsx("a", { href: safeUrl(profile.url), children: profile.username })
        ] }, index))
      ] })
    ] }),
    /* @__PURE__ */ jsxs(MainGrid, { children: [
      /* @__PURE__ */ jsxs(Sidebar, { children: [
        skills.length > 0 && /* @__PURE__ */ jsxs(SidebarSection, { children: [
          ...
          /* @__PURE__ */ jsx(SidebarContent, { children: skills.map((skill, index) => /* @__PURE__ */ jsxs(SkillItem, { children: [
        ...
        languages.length > 0 && /* @__PURE__ */ jsxs(SidebarSection, { children: [
          ...
          /* @__PURE__ */ jsx(SidebarContent, { children: /* @__PURE__ */ jsx(SimpleList, { children: languages.map((lang, index) => /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxs(MainContent, { children: [
        basics.summary && /* @__PURE__ */ jsxs(MainSection, { children: [
          /* @__PURE__ */ jsx(MainSectionTitle, { children: "Summary" }),
          /* @__PURE__ */ jsx(ContentColumn, { children: /* @__PURE__ */ jsx(WorkDescription, { children: basics.summary }) })
        ] }),
        work.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
          /* @__PURE__ */ jsx(MainSectionTitle, { children: "Experience" }),
          work.map((job, index) => /* @__PURE__ */ jsxs(WorkGrid, { children: [
        ...
        education.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
          ...
          education.map((edu, index) => /* @__PURE__ */ jsxs(WorkGrid, { children: [
            /* @__PURE__ */ jsx(DateColumn, { children: /* @__PURE__ */ jsx(
              DateRange,
              {
        ...
        projects.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
          ...
          projects.map((project, index) => /* @__PURE__ */ jsxs(WorkGrid, { children: [
            /* @__PURE__ */ jsx(DateColumn, { children: /* @__PURE__ */ jsx(
              DateRange,
              {
