...
`;
const PlateCaption = dt.figcaption`
  font-size: 10px;
...
const BlockTitle = dt.h2`
  ...
  color: ${INK};
`;
const BlockBody = dt.div`
  display: flex;
  flex-direction: column;
  gap: 40px;
  min-width: 0;
`;
const Entry = dt.article`
  display: flex;
  flex-direction: column;
  gap: 6px;
`;
const EntryTop = dt.div`
  display: flex;
  flex-wrap: wrap;
  align-items: baseline;
  gap: 10px 16px;
...
const Tag = dt.span`
  ...
  background: transparent;
`;
const SkillGroup = dt.div`
  display: flex;
  flex-direction: column;
  gap: 8px;
`;
const SkillName = dt.div`
  font-family: 'Archivo', sans-serif;
  font-weight: 700;
  font-size: 13px;
...
const Pair = dt.div`
  ...
  gap: 2px;
`;
const PairKey = dt.span`
  font-family: 'Archivo', sans-serif;
  font-weight: 700;
  font-size: 16px;
  color: ${INK};
`;
const PairVal = dt.span`
  font-size: 13px;
  color: ${MUTE};
`;
const Colophon = dt.footer`
  margin-top: 88px;
  padding-top: 22px;
...
function Highlights({ items }) {
  ...
  return /* @__PURE__ */ jsx(Bullets, { children: items.map((h, i) => /* @__PURE__ */ jsx("li", { children: h }, i)) });
}
function SectionBlock({ index: index2, title, children }) {
  return /* @__PURE__ */ jsxs(Block, { children: [
    /* @__PURE__ */ jsxs(BlockHead, { children: [
      /* @__PURE__ */ jsx(Index, { children: `(${pad(index2)})` }),
      /* @__PURE__ */ jsx(BlockTitle, { children: title })
    ] }),
    /* @__PURE__ */ jsx(BlockBody, { children })
  ] });
}
function Resume({ resume }) {
  ...
  let counter = 0;
  const next2 = () => counter += 1;
  return /* @__PURE__ */ jsx(Page, { children: /* @__PURE__ */ jsxs(Frame, { children: [
    /* @__PURE__ */ jsxs(Header, { children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(Kicker, { children: "Portfolio / Curriculum Vitae" }),
        basics.name && /* @__PURE__ */ jsx(Name, { children: basics.name }),
        basics.label && /* @__PURE__ */ jsx(Label, { children: basics.label })
      ] }),
      basics.image && /* @__PURE__ */ jsxs(Plate, { children: [
        /* @__PURE__ */ jsx(PlateImg, { src: safeUrl(basics.image), alt: basics.name || "" }),
        /* @__PURE__ */ jsx(PlateCaption, { children: "Plate I — Self" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs(ContactBar, { children: [
      basics.email && /* @__PURE__ */ jsxs("span", { children: [
        /* @__PURE__ */ jsx(ContactKey, { children: "Email" }),
        /* @__PURE__ */ jsx("a", { href: safeUrl(`mailto:${basics.email}`), children: basics.email })
      ] }),
      basics.phone && /* @__PURE__ */ jsxs("span", { children: [
        /* @__PURE__ */ jsx(ContactKey, { children: "Tel" }),
        /* @__PURE__ */ jsx("a", { href: safeUrl(`tel:${basics.phone}`), children: basics.phone })
      ] }),
      basics.url && /* @__PURE__ */ jsxs("span", { children: [
        /* @__PURE__ */ jsx(ContactKey, { children: "Web" }),
        /* @__PURE__ */ jsx("a", { href: safeUrl(basics.url), children: basics.url.replace(/^https?:\/\//, "").replace(/\/$/, "") })
      ] }),
      loc && /* @__PURE__ */ jsxs("span", { children: [
        /* @__PURE__ */ jsx(ContactKey, { children: "Locale" }),
        loc
      ] }),
      profiles.map(
        (p2, i) => p2.url ? /* @__PURE__ */ jsxs("span", { children: [
          /* @__PURE__ */ jsx(ContactKey, { children: p2.network || "Link" }),
          /* @__PURE__ */ jsx("a", { href: safeUrl(p2.url), children: p2.username || p2.network })
        ] }, i) : null
      )
    ] }),
    basics.summary && /* @__PURE__ */ jsxs(Statement, { children: [
      /* @__PURE__ */ jsx(StatementMark, { children: "— Statement" }),
      /* @__PURE__ */ jsx(StatementText, { children: basics.summary })
    ] }),
    work.length > 0 && /* @__PURE__ */ jsx(SectionBlock, { index: next2(), title: "Work", children: work.map((job, i) => /* @__PURE__ */ jsxs(Entry, { children: [
      /* @__PURE__ */ jsxs(EntryTop, { children: [
        /* @__PURE__ */ jsx(EntryTitle, { children: job.position || job.name }),
        /* @__PURE__ */ jsx(EntryMeta, { children: /* @__PURE__ */ jsx(DateRange, { startDate: job.startDate, endDate: job.endDate }) })
      ] }),
      job.name && job.position && /* @__PURE__ */ jsx(EntrySub, { children: job.name }),
      job.location && /* @__PURE__ */ jsx(EntryMeta, { children: job.location }),
      job.summary && /* @__PURE__ */ jsx(EntryText, { children: job.summary }),
      /* @__PURE__ */ jsx(Highlights, { items: job.highlights })
    ] }, i)) }),
    projects.length > 0 && /* @__PURE__ */ jsx(SectionBlock, { index: next2(), title: "Works", children: projects.map((proj, i) => /* @__PURE__ */ jsxs(Entry, { children: [
      /* @__PURE__ */ jsxs(EntryTop, { children: [
        /* @__PURE__ */ jsx(EntryTitle, { children: proj.url ? /* @__PURE__ */ jsx(Link, { href: safeUrl(proj.url), children: proj.name }) : proj.name }),
        /* @__PURE__ */ jsx(EntryMeta, { children: /* @__PURE__ */ jsx(
          DateRange,
          {
      ...
      proj.type && /* @__PURE__ */ jsx(EntrySub, { children: proj.type }),
      proj.description && /* @__PURE__ */ jsx(EntryText, { children: proj.description }),
      /* @__PURE__ */ jsx(Highlights, { items: proj.highlights }),
      proj.keywords && proj.keywords.length > 0 && /* @__PURE__ */ jsx(TagWrap, { children: proj.keywords.map((k2, j2) => /* @__PURE__ */ jsx(Tag, { children: k2 }, j2)) })
    ] }, i)) }),
    education.length > 0 && /* @__PURE__ */ jsx(SectionBlock, { index: next2(), title: "Study", children: education.map((edu, i) => /* @__PURE__ */ jsxs(Entry, { children: [
      /* @__PURE__ */ jsxs(EntryTop, { children: [
        /* @__PURE__ */ jsx(EntryTitle, { children: edu.institution }),
        /* @__PURE__ */ jsx(EntryMeta, { children: /* @__PURE__ */ jsx(DateRange, { startDate: edu.startDate, endDate: edu.endDate }) })
      ] }),
      (edu.studyType || edu.area) && /* @__PURE__ */ jsx(EntrySub, { children: [edu.studyType, edu.area].filter(Boolean).join(", ") }),
      edu.score && /* @__PURE__ */ jsxs(EntryText, { children: [
        "Result: ",
        edu.score
      ] }),
      edu.courses && edu.courses.length > 0 && /* @__PURE__ */ jsx(Highlights, { items: edu.courses })
    ] }, i)) }),
    skills.length > 0 && /* @__PURE__ */ jsx(SectionBlock, { index: next2(), title: "Skills", children: skills.map((skill, i) => /* @__PURE__ */ jsxs(SkillGroup, { children: [
      /* @__PURE__ */ jsxs(SkillName, { children: [
        skill.name,
        skill.level ? ` — ${skill.level}` : ""
      ] }),
      skill.keywords && skill.keywords.length > 0 && /* @__PURE__ */ jsx(TagWrap, { children: skill.keywords.map((k2, j2) => /* @__PURE__ */ jsx(Tag, { children: k2 }, j2)) })
    ] }, i)) }),
    awards.length > 0 && /* @__PURE__ */ jsx(SectionBlock, { index: next2(), title: "Awards", children: /* @__PURE__ */ jsx(Rows, { children: awards.map((a, i) => /* @__PURE__ */ jsxs(Entry, { children: [
      /* @__PURE__ */ jsxs(EntryTop, { children: [
        /* @__PURE__ */ jsx(EntryTitle, { children: a.title }),
        a.date && /* @__PURE__ */ jsx(EntryMeta, { children: a.date })
      ] }),
      a.awarder && /* @__PURE__ */ jsx(EntrySub, { children: a.awarder }),
      a.summary && /* @__PURE__ */ jsx(EntryText, { children: a.summary })
    ] }, i)) }) }),
    certificates.length > 0 && /* @__PURE__ */ jsx(SectionBlock, { index: next2(), title: "Certificates", children: /* @__PURE__ */ jsx(Rows, { children: certificates.map((c, i) => /* @__PURE__ */ jsxs(Entry, { children: [
      /* @__PURE__ */ jsxs(EntryTop, { children: [
        /* @__PURE__ */ jsx(EntryTitle, { children: c.url ? /* @__PURE__ */ jsx(Link, { href: safeUrl(c.url), children: c.name }) : c.name }),
        c.date && /* @__PURE__ */ jsx(EntryMeta, { children: c.date })
      ] }),
      c.issuer && /* @__PURE__ */ jsx(EntrySub, { children: c.issuer })
    ] }, i)) }) }),
    publications.length > 0 && /* @__PURE__ */ jsx(SectionBlock, { index: next2(), title: "Published", children: /* @__PURE__ */ jsx(Rows, { children: publications.map((p2, i) => /* @__PURE__ */ jsxs(Entry, { children: [
      /* @__PURE__ */ jsxs(EntryTop, { children: [
        /* @__PURE__ */ jsx(EntryTitle, { children: p2.url ? /* @__PURE__ */ jsx(Link, { href: safeUrl(p2.url), children: p2.name }) : p2.name }),
        p2.releaseDate && /* @__PURE__ */ jsx(EntryMeta, { children: p2.releaseDate })
      ] }),
      p2.publisher && /* @__PURE__ */ jsx(EntrySub, { children: p2.publisher }),
      p2.summary && /* @__PURE__ */ jsx(EntryText, { children: p2.summary })
    ] }, i)) }) }),
    volunteer.length > 0 && /* @__PURE__ */ jsx(SectionBlock, { index: next2(), title: "Service", children: volunteer.map((v2, i) => /* @__PURE__ */ jsxs(Entry, { children: [
      /* @__PURE__ */ jsxs(EntryTop, { children: [
        /* @__PURE__ */ jsx(EntryTitle, { children: v2.position || v2.organization }),
        /* @__PURE__ */ jsx(EntryMeta, { children: /* @__PURE__ */ jsx(DateRange, { startDate: v2.startDate, endDate: v2.endDate }) })
      ] }),
      v2.organization && v2.position && /* @__PURE__ */ jsx(EntrySub, { children: v2.organization }),
      v2.summary && /* @__PURE__ */ jsx(EntryText, { children: v2.summary }),
      /* @__PURE__ */ jsx(Highlights, { items: v2.highlights })
    ] }, i)) }),
    languages.length > 0 && /* @__PURE__ */ jsx(SectionBlock, { index: next2(), title: "Languages", children: /* @__PURE__ */ jsx(InlineList, { children: languages.map((l, i) => /* @__PURE__ */ jsxs(Pair, { children: [
      /* @__PURE__ */ jsx(PairKey, { children: l.language }),
      l.fluency && /* @__PURE__ */ jsx(PairVal, { children: l.fluency })
    ] }, i)) }) }),
    interests.length > 0 && /* @__PURE__ */ jsx(SectionBlock, { index: next2(), title: "Interests", children: /* @__PURE__ */ jsx(Rows, { children: interests.map((it2, i) => /* @__PURE__ */ jsxs(Entry, { children: [
      /* @__PURE__ */ jsx(EntryTitle, { children: it2.name }),
      it2.keywords && it2.keywords.length > 0 && /* @__PURE__ */ jsx(TagWrap, { children: it2.keywords.map((k2, j2) => /* @__PURE__ */ jsx(Tag, { children: k2 }, j2)) })
    ] }, i)) }) }),
    references.length > 0 && /* @__PURE__ */ jsx(SectionBlock, { index: next2(), title: "References", children: /* @__PURE__ */ jsx(Rows, { children: references.map((r, i) => /* @__PURE__ */ jsxs(Entry, { children: [
      /* @__PURE__ */ jsx(EntryTitle, { children: r.name }),
      r.reference && /* @__PURE__ */ jsxs(EntryText, { children: [
        "“",
        r.reference,
        "”"
      ] })
    ] }, i)) }) }),
    /* @__PURE__ */ jsxs(Colophon, { children: [
      /* @__PURE__ */ jsx("span", { children: basics.name || "Curriculum Vitae" }),
      /* @__PURE__ */ jsx("span", { children: "Art School Modern" })
    ] })
  ] }) });
}
