...
const StyledBadge = dt(Badge)`
  ...
  border-radius: 4px;
`;
const EducationCard = dt(WorkCard)``;
const ProjectCard = dt(WorkCard)``;
...
function Resume({ resume }) {
  ...
  return /* @__PURE__ */ jsxs(Layout, { children: [
    ...
    work.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
      ...
      work.map((job, index2) => /* @__PURE__ */ jsxs(WorkCard, { children: [
        /* @__PURE__ */ jsxs(WorkHeader, { children: [
          ...
          /* @__PURE__ */ jsxs(WorkMeta, { children: [
            /* @__PURE__ */ jsx(DateRange, { startDate: job.startDate, endDate: job.endDate }),
            job.location && ` • ${job.location}`
          ] })
        ] }),
        job.summary && /* @__PURE__ */ jsx(WorkDescription, { children: job.summary }),
        job.highlights && job.highlights.length > 0 && /* @__PURE__ */ jsxs(ImpactSection, { children: [
          /* @__PURE__ */ jsx(ImpactLabel, { children: "Key Impact" }),
          /* @__PURE__ */ jsx(WorkHighlights, { children: job.highlights.map((highlight, i) => /* @__PURE__ */ jsx(
            "li",
            {
    ...
    skills.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
      ...
      /* @__PURE__ */ jsx(SkillsGrid, { children: skills.map((skill, index2) => /* @__PURE__ */ jsxs(SkillCard, { children: [
    ...
    projects.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
      ...
      projects.map((project, index2) => /* @__PURE__ */ jsxs(ProjectCard, { children: [
        /* @__PURE__ */ jsxs(WorkHeader, { children: [
        ...
        project.highlights && project.highlights.length > 0 && /* @__PURE__ */ jsxs(ImpactSection, { children: [
          /* @__PURE__ */ jsx(ImpactLabel, { children: "Outcomes" }),
          /* @__PURE__ */ jsx(WorkHighlights, { children: project.highlights.map((highlight, i) => /* @__PURE__ */ jsx("li", { children: highlight }, i)) })
        ] })
      ] }, index2))
    ] }),
    education.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
      /* @__PURE__ */ jsx(MainSectionTitle, { children: "Education" }),
      education.map((edu, index2) => /* @__PURE__ */ jsx(EducationCard, { children: /* @__PURE__ */ jsxs(WorkHeader, { children: [
        ...
        /* @__PURE__ */ jsxs(WorkMeta, { children: [
          /* @__PURE__ */ jsx(DateRange, { startDate: edu.startDate, endDate: edu.endDate }),
          edu.score && ` • ${edu.score}`
        ] })
      ] }) }, index2))
    ] }),
    volunteer.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
      ...
      volunteer.map((vol, index2) => /* @__PURE__ */ jsxs(WorkCard, { children: [
        /* @__PURE__ */ jsxs(WorkHeader, { children: [
    ...
    awards.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
      ...
      /* @__PURE__ */ jsx(SimpleList, { children: awards.map((award, index2) => /* @__PURE__ */ jsxs(SimpleCard, { children: [
    ...
    publications.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
      ...
      /* @__PURE__ */ jsx(SimpleList, { children: publications.map((pub, index2) => /* @__PURE__ */ jsxs(SimpleCard, { children: [
    ...
    languages.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
      ...
      /* @__PURE__ */ jsx(SimpleList, { children: languages.map((lang, index2) => /* @__PURE__ */ jsxs(SimpleCard, { children: [
    ...
    interests.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
      ...
      /* @__PURE__ */ jsx(SimpleList, { children: interests.map((interest, index2) => /* @__PURE__ */ jsxs(SimpleCard, { children: [
        /* @__PURE__ */ jsx("strong", { children: interest.name }),
        interest.keywords && interest.keywords.length > 0 && /* @__PURE__ */ jsx(StyledBadgeList, { style: { marginTop: "8px" }, children: interest.keywords.map((keyword, i) => /* @__PURE__ */ jsx(StyledBadge, { children: keyword }, i)) })
      ] }, index2)) })
    ] }),
    references.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
      /* @__PURE__ */ jsx(MainSectionTitle, { children: "References" }),
      references.map((ref, index2) => /* @__PURE__ */ jsxs(WorkCard, { children: [
