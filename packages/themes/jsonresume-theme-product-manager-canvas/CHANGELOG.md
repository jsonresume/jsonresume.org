# jsonresume-theme-product-manager-canvas

## 0.2.4

### Patch Changes

- 24555c2: Fix contact info not rendering: ContactInfo was called with unsupported per-field props (`type`/children) and returned null; now uses the supported `basics` prop.
