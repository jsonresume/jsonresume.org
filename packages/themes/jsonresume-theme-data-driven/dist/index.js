...
`;
const ItemTitle = dt.div`
  font-size: 12px;
  font-weight: 700;
  color: var(--resume-color-primary);
`;
const ItemSubtitle = dt.div`
  font-size: 11px;
  color: var(--resume-color-secondary);
  margin-bottom: 2px;
  font-weight: 600;
...
function boldNumbers(text) {
  ...
  return text.replace(
    /(\$)?(\d+(?:,\d{3})*(?:\.\d+)?)([KkMmBb])?([+\-])?(%)?/g,
    (match2, dollar, number, suffix, plusminus, percent) => {
      const hasMarker = dollar || suffix || plusminus || percent || number.includes(",") || number.includes(".");
      if (!hasMarker) return match2;
      const parts = [dollar, number, suffix, plusminus, percent].filter(Boolean).join("");
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(Container, { children: [
      /* @__PURE__ */ jsxs(Header, { children: [
        ...
        (basics.email || basics.phone || basics.url || basics.location || basics.profiles?.length > 0) && /* @__PURE__ */ jsxs(Contact, { children: [
          basics.email && /* @__PURE__ */ jsx("a", { href: `mailto:${basics.email}`, children: basics.email }),
          basics.phone && /* @__PURE__ */ jsx("span", { children: basics.phone }),
          basics.url && /* @__PURE__ */ jsx("a", { href: basics.url, target: "_blank", rel: "noopener noreferrer", children: basics.url.replace(/^https?:\/\//, "") }),
          basics.location && /* @__PURE__ */ jsx("span", { children: [basics.location.city, basics.location.region].filter(Boolean).join(", ") }),
          basics.profiles?.map((profile, i) => /* @__PURE__ */ jsx(
            "a",
            {
              href: profile.url,
              target: "_blank",
              rel: "noopener noreferrer",
              children: profile.network
            },
            i
          ))
        ] }),
      ...
      work.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
        /* @__PURE__ */ jsx(SectionTitle, { children: "Professional Experience" }),
        work.map((job, i) => /* @__PURE__ */ jsxs(Item, { children: [
          /* @__PURE__ */ jsx(ItemHeader, { children: /* @__PURE__ */ jsx(ItemTitle, { children: job.position }) }),
          job.name && /* @__PURE__ */ jsx(ItemSubtitle, { children: job.name }),
          (job.startDate || job.location) && /* @__PURE__ */ jsxs(ItemMeta, { children: [
            job.startDate && /* @__PURE__ */ jsx("span", { children: formatDateRange({
              startDate: job.startDate,
              endDate: job.endDate
            }) }),
            job.location && /* @__PURE__ */ jsx("span", { children: job.location })
          ] }),
          ...
          job.highlights?.length > 0 && /* @__PURE__ */ jsx(Highlights, { children: job.highlights.map((highlight, j2) => /* @__PURE__ */ jsx(
            "li",
            {
              dangerouslySetInnerHTML: {
      ...
      education.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
        ...
        education.map((edu, i) => {
          ...
          return /* @__PURE__ */ jsxs(Item, { children: [
            /* @__PURE__ */ jsx(ItemHeader, { children: /* @__PURE__ */ jsx(ItemTitle, { children: title || edu.institution }) }),
            title && /* @__PURE__ */ jsx(ItemSubtitle, { children: edu.institution }),
            edu.startDate && /* @__PURE__ */ jsx(ItemMeta, { children: /* @__PURE__ */ jsx("span", { children: formatDateRange({
              startDate: edu.startDate,
              endDate: edu.endDate
            }) }) }),
            highlights.length > 0 && /* @__PURE__ */ jsx(Highlights, { children: highlights.map((highlight, j2) => /* @__PURE__ */ jsx(
              "li",
              {
      ...
      skills.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
        /* @__PURE__ */ jsx(SectionTitle, { children: "Technical Skills" }),
        skills.map((skillGroup, i) => /* @__PURE__ */ jsxs(SkillGroup, { children: [
          skillGroup.name && /* @__PURE__ */ jsx("strong", { children: skillGroup.name }),
          skillGroup.keywords?.length > 0 && /* @__PURE__ */ jsx(BadgeList, { children: skillGroup.keywords.map((keyword, j2) => /* @__PURE__ */ jsx(Badge, { children: keyword }, j2)) })
        ] }, i))
      ] }),
      projects.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
        /* @__PURE__ */ jsx(SectionTitle, { children: "Key Projects" }),
        projects.map((project, i) => /* @__PURE__ */ jsxs(Item, { children: [
          /* @__PURE__ */ jsx(ItemHeader, { children: /* @__PURE__ */ jsx(ItemTitle, { children: project.name }) }),
          project.startDate && /* @__PURE__ */ jsx(ItemMeta, { children: /* @__PURE__ */ jsx("span", { children: formatDateRange({
          ...
          project.url && /* @__PURE__ */ jsx(Description, { children: /* @__PURE__ */ jsx(
            "a",
            {
              href: project.url,
              target: "_blank",
          ...
          project.keywords?.length > 0 && /* @__PURE__ */ jsx(BadgeList, { children: project.keywords.map((keyword, j2) => /* @__PURE__ */ jsx(Badge, { children: keyword }, j2)) }),
          project.highlights?.length > 0 && /* @__PURE__ */ jsx(Highlights, { children: project.highlights.map((highlight, j2) => /* @__PURE__ */ jsx(
            "li",
            {
              dangerouslySetInnerHTML: {
                __html: boldNumbers(highlight)
      ...
      volunteer.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
        /* @__PURE__ */ jsx(SectionTitle, { children: "Volunteer Work" }),
        volunteer.map((vol, i) => /* @__PURE__ */ jsxs(Item, { children: [
          /* @__PURE__ */ jsx(ItemHeader, { children: /* @__PURE__ */ jsx(ItemTitle, { children: vol.position }) }),
          vol.organization && /* @__PURE__ */ jsx(ItemSubtitle, { children: vol.organization }),
          vol.startDate && /* @__PURE__ */ jsx(ItemMeta, { children: /* @__PURE__ */ jsx("span", { children: formatDateRange({
          ...
          vol.highlights?.length > 0 && /* @__PURE__ */ jsx(Highlights, { children: vol.highlights.map((highlight, j2) => /* @__PURE__ */ jsx(
            "li",
            {
              dangerouslySetInnerHTML: {
                __html: boldNumbers(highlight)
      ...
      awards.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
        /* @__PURE__ */ jsx(SectionTitle, { children: "Awards & Recognition" }),
        awards.map((award, i) => /* @__PURE__ */ jsxs(Item, { children: [
          /* @__PURE__ */ jsx(ItemHeader, { children: /* @__PURE__ */ jsx(ItemTitle, { children: award.title }) }),
          award.awarder && /* @__PURE__ */ jsx(ItemSubtitle, { children: award.awarder }),
          award.date && /* @__PURE__ */ jsx(ItemMeta, { children: /* @__PURE__ */ jsx("span", { children: award.date }) }),
