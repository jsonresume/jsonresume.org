...
const ContactLabel = dt.div`
  ...
  font-weight: 600;
`;
const ContactValue = dt.div`
  color: #2c3e50;
  word-break: break-word;
`;
const InterestsList = dt.div`
  display: flex;
  flex-wrap: wrap;
  gap: 8px;
`;
const InterestTag = dt.span`
  display: inline-block;
  padding: 4px 12px;
  background: #ecf0f1;
  color: #34495e;
...
function Resume({ resume }) {
  ...
  return /* @__PURE__ */ jsxs(ResumeContainer, { children: [
    /* @__PURE__ */ jsx(Header, { children: basics && /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(TwoColumnLayout, { children: [
      /* @__PURE__ */ jsxs(Sidebar, { children: [
        basics && /* @__PURE__ */ jsxs(StyledSection, { children: [
          /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Contact" }),
          basics.email && /* @__PURE__ */ jsxs(ContactItem, { children: [
            /* @__PURE__ */ jsx(ContactLabel, { children: "Email" }),
            /* @__PURE__ */ jsx(ContactValue, { children: /* @__PURE__ */ jsx(Link, { href: `mailto:${basics.email}`, children: basics.email }) })
          ] }),
          basics.phone && /* @__PURE__ */ jsxs(ContactItem, { children: [
            /* @__PURE__ */ jsx(ContactLabel, { children: "Phone" }),
            /* @__PURE__ */ jsx(ContactValue, { children: basics.phone })
          ] }),
          basics.location && /* @__PURE__ */ jsxs(ContactItem, { children: [
            /* @__PURE__ */ jsx(ContactLabel, { children: "Location" }),
            /* @__PURE__ */ jsx(ContactValue, { children: [
              basics.location.city,
              basics.location.region,
              basics.location.countryCode
            ].filter(Boolean).join(", ") })
          ] }),
          basics.url && /* @__PURE__ */ jsxs(ContactItem, { children: [
            /* @__PURE__ */ jsx(ContactLabel, { children: "Website" }),
            /* @__PURE__ */ jsx(ContactValue, { children: /* @__PURE__ */ jsx(
              Link,
              {
                href: safeUrl(basics.url),
                target: isExternalUrl(basics.url) ? "_blank" : void 0,
                children: basics.url.replace(/^https?:\/\//, "")
              }
            ) })
          ] }),
          basics.profiles && basics.profiles.length > 0 && basics.profiles.map((profile, index) => /* @__PURE__ */ jsxs(ContactItem, { children: [
            /* @__PURE__ */ jsx(ContactLabel, { children: profile.network }),
            /* @__PURE__ */ jsx(ContactValue, { children: /* @__PURE__ */ jsx(
              Link,
              {
                href: safeUrl(profile.url),
                target: isExternalUrl(profile.url) ? "_blank" : void 0,
                children: profile.username || profile.url.replace(/^https?:\/\//, "")
              }
            ) })
          ] }, index))
        ] }),
        skills && skills.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
          ...
          skills.map((skill, index) => /* @__PURE__ */ jsxs(SkillCategory, { children: [
            skill.name && /* @__PURE__ */ jsx(SkillName, { children: skill.name }),
            skill.keywords && skill.keywords.length > 0 && /* @__PURE__ */ jsx(SkillKeywords, { children: skill.keywords.join(" • ") })
          ] }, index))
        ] }),
        languages && languages.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
          /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Languages" }),
          languages.map((language, index) => /* @__PURE__ */ jsxs(LanguageItem, { children: [
            /* @__PURE__ */ jsx(LanguageName, { children: language.language }),
            language.fluency && /* @__PURE__ */ jsxs(LanguageFluency, { children: [
              "(",
              language.fluency,
              ")"
            ] })
      ...
      /* @__PURE__ */ jsxs(MainContent, { children: [
        work && work.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
          ...
          work.map((job, index) => /* @__PURE__ */ jsxs(ExperienceItem, { children: [
            /* @__PURE__ */ jsxs(ExperienceHeader, { children: [
              job.position && /* @__PURE__ */ jsx(Position, { children: job.position }),
            ...
            job.summary && /* @__PURE__ */ jsx(Description, { children: job.summary }),
            job.highlights && job.highlights.length > 0 && /* @__PURE__ */ jsx(Highlights, { children: job.highlights.map((highlight, i) => /* @__PURE__ */ jsx(Highlight, { children: highlight }, i)) })
          ] }, index))
        ] }),
        education && education.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
          ...
          education.map((edu, index) => /* @__PURE__ */ jsxs(EducationItem, { children: [
            ...
            edu.studyType && edu.area && /* @__PURE__ */ jsxs(Degree, { children: [
              edu.studyType,
              " in ",
              edu.area
            ] }),
        ...
        projects && projects.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
          ...
          projects.map((project, index) => /* @__PURE__ */ jsxs(ExperienceItem, { children: [
            /* @__PURE__ */ jsxs(ExperienceHeader, { children: [
              project.name && /* @__PURE__ */ jsx(Position, { children: project.name }),
              project.url && /* @__PURE__ */ jsx(Company, { children: /* @__PURE__ */ jsx(
                Link,
                {
                  href: safeUrl(project.url),
                  target: isExternalUrl(project.url) ? "_blank" : void 0,
            ...
            project.description && /* @__PURE__ */ jsx(Description, { children: project.description }),
            project.highlights && project.highlights.length > 0 && /* @__PURE__ */ jsx(Highlights, { children: project.highlights.map((highlight, i) => /* @__PURE__ */ jsx(Highlight, { children: highlight }, i)) })
          ] }, index))
        ] }),
