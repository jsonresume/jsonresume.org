...
function Resume({ resume }) {
  ...
  return /* @__PURE__ */ jsxs(Layout, { children: [
    ...
    work.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      work.map((job, index) => /* @__PURE__ */ jsxs(GridItem, { children: [
        /* @__PURE__ */ jsxs(MetaColumn, { children: [
          /* @__PURE__ */ jsx(MetaDate, { children: /* @__PURE__ */ jsx(DateRange, { startDate: job.startDate, endDate: job.endDate }) }),
          job.location && /* @__PURE__ */ jsx(MetaLocation, { children: job.location })
        ] }),
        /* @__PURE__ */ jsxs(ContentColumn, { children: [
          /* @__PURE__ */ jsx(ItemTitle, { children: job.position || job.name }),
          job.name && /* @__PURE__ */ jsx(ItemSubtitle, { children: job.name }),
          job.summary && /* @__PURE__ */ jsx(ItemDescription, { children: job.summary }),
          job.highlights && job.highlights.length > 0 && /* @__PURE__ */ jsx(HighlightsList, { children: job.highlights.map((highlight, i) => /* @__PURE__ */ jsx("li", { children: highlight }, i)) })
        ] })
      ] }, index))
    ] }),
    education.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Education" }),
      education.map((edu, index) => /* @__PURE__ */ jsxs(GridItem, { children: [
        /* @__PURE__ */ jsxs(MetaColumn, { children: [
          /* @__PURE__ */ jsx(MetaDate, { children: /* @__PURE__ */ jsx(DateRange, { startDate: edu.startDate, endDate: edu.endDate }) }),
          edu.area && /* @__PURE__ */ jsx(MetaLocation, { children: edu.area })
        ] }),
        /* @__PURE__ */ jsxs(ContentColumn, { children: [
          /* @__PURE__ */ jsx(ItemTitle, { children: edu.institution }),
          edu.studyType && edu.area && /* @__PURE__ */ jsxs(ItemSubtitle, { children: [
            edu.studyType,
            " in ",
            edu.area
          ] }),
          edu.score && /* @__PURE__ */ jsxs(ItemDescription, { children: [
            "GPA: ",
            edu.score
          ] }),
          edu.courses && edu.courses.length > 0 && /* @__PURE__ */ jsx(HighlightsList, { children: edu.courses.map((course, i) => /* @__PURE__ */ jsx("li", { children: course }, i)) })
        ] })
      ] }, index))
    ] }),
    ...
    projects.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      projects.map((project, index) => /* @__PURE__ */ jsxs(GridItem, { children: [
        /* @__PURE__ */ jsxs(MetaColumn, { children: [
          ...
          project.type && /* @__PURE__ */ jsx(MetaLocation, { children: project.type })
        ] }),
        /* @__PURE__ */ jsxs(ContentColumn, { children: [
          /* @__PURE__ */ jsx(ItemTitle, { children: project.url ? /* @__PURE__ */ jsx(Link, { href: safeUrl(project.url), children: project.name }) : project.name }),
          project.description && /* @__PURE__ */ jsx(ItemDescription, { children: project.description }),
          project.highlights && project.highlights.length > 0 && /* @__PURE__ */ jsx(HighlightsList, { children: project.highlights.map((highlight, i) => /* @__PURE__ */ jsx("li", { children: highlight }, i)) })
        ] })
      ] }, index))
    ] }),
    awards.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      /* @__PURE__ */ jsx(SimpleList, { children: awards.map((award, index) => /* @__PURE__ */ jsxs(SimpleItem, { children: [
        /* @__PURE__ */ jsx("h4", { children: award.title }),
    ...
    volunteer.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      volunteer.map((vol, index) => /* @__PURE__ */ jsxs(GridItem, { children: [
        /* @__PURE__ */ jsx(MetaColumn, { children: /* @__PURE__ */ jsx(MetaDate, { children: /* @__PURE__ */ jsx(DateRange, { startDate: vol.startDate, endDate: vol.endDate }) }) }),
        /* @__PURE__ */ jsxs(ContentColumn, { children: [
          ...
          vol.highlights && vol.highlights.length > 0 && /* @__PURE__ */ jsx(HighlightsList, { children: vol.highlights.map((highlight, i) => /* @__PURE__ */ jsx("li", { children: highlight }, i)) })
        ] })
      ] }, index))
    ] }),
    languages.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Languages" }),
      /* @__PURE__ */ jsx(StyledBadgeList, { children: languages.map((lang, index) => /* @__PURE__ */ jsxs(StyledBadge, { children: [
        lang.language,
        " ",
    ...
    references.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      /* @__PURE__ */ jsx(SimpleList, { children: references.map((ref, index) => /* @__PURE__ */ jsxs(SimpleItem, { children: [
        /* @__PURE__ */ jsx("h4", { children: ref.name }),
