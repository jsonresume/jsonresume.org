...
const Station = dt.div`
  ...
  padding: 14px 0;
`;
const StationCell = dt.div`
  display: flex;
  flex-direction: column;
  gap: 2px;
  padding: 4px 0;
`;
const StationKey = dt.span`
...
`;
const LogSection = dt(Section)`
  margin-bottom: 40px;
`;
const LogHeading = dt.div`
  display: flex;
  align-items: baseline;
  gap: 14px;
  margin-bottom: 22px;
...
`;
const LogTitle = dt(SectionTitle)`
  font-family: 'IBM Plex Mono', monospace;
  font-size: 14px;
  font-weight: 600;
...
`;
const EntrySubtitle = dt.div`
  font-size: 16px;
  font-style: italic;
  color: ${TEAL_DEEP};
  margin-top: 1px;
`;
const EntryText = dt.p`
  margin: 8px 0 0 0;
  font-size: 15.5px;
  line-height: 1.66;
  color: ${INK_SOFT};
`;
const Findings = dt.ul`
  margin: 12px 0 0 0;
  padding: 0;
  list-style: none;
  display: flex;
...
`;
const SpecimenGrid = dt.div`
  display: grid;
  grid-template-columns: repeat(auto-fill, minmax(238px, 1fr));
  gap: 18px;
`;
const Specimen = dt.div`
  padding: 16px 18px 18px;
  background: ${PAPER_TINT};
  border: 1px solid ${RULE};
  border-top: 3px solid ${TEAL};
`;
const SpecimenName = dt.h4`
  font-family: 'IBM Plex Mono', monospace;
  font-size: 12px;
  font-weight: 600;
...
`;
const LedgerText = dt.p`
  margin: 5px 0 0 0;
  font-size: 15px;
  line-height: 1.6;
  color: ${INK_SOFT};
`;
const LangGrid = dt.div`
  display: grid;
  grid-template-columns: repeat(auto-fill, minmax(220px, 1fr));
  gap: 14px;
`;
const LangItem = dt.div`
  display: flex;
  flex-direction: column;
  gap: 2px;
  padding-bottom: 8px;
...
function locationString(location) {
  ...
  return [location.city, location.region, location.countryCode].filter(Boolean).join(", ") || null;
}
function pad(n) {
  return String(n).padStart(2, "0");
}
function endOf(item = {}) {
  if (!item.startDate) return void 0;
...
function Resume({ resume = {} }) {
  ...
  return /* @__PURE__ */ jsxs(Layout, { children: [
    /* @__PURE__ */ jsxs(Header, { children: [
      /* @__PURE__ */ jsx(Eyebrow, { children: "Field Record" }),
      basics.name && /* @__PURE__ */ jsx(Name, { children: basics.name }),
      basics.label && /* @__PURE__ */ jsx(Label, { children: basics.label }),
      /* @__PURE__ */ jsxs(Station, { children: [
        headerLocation && /* @__PURE__ */ jsxs(StationCell, { children: [
          /* @__PURE__ */ jsx(StationKey, { children: "Station" }),
          /* @__PURE__ */ jsx(StationVal, { children: headerLocation })
        ] }),
        basics.email && /* @__PURE__ */ jsxs(StationCell, { children: [
          /* @__PURE__ */ jsx(StationKey, { children: "Correspondence" }),
          /* @__PURE__ */ jsx(StationVal, { children: /* @__PURE__ */ jsx("a", { href: safeUrl(`mailto:${basics.email}`), children: basics.email }) })
        ] }),
        basics.phone && /* @__PURE__ */ jsxs(StationCell, { children: [
          /* @__PURE__ */ jsx(StationKey, { children: "Signal" }),
          /* @__PURE__ */ jsx(StationVal, { children: basics.phone })
        ] }),
        basics.url && /* @__PURE__ */ jsxs(StationCell, { children: [
          /* @__PURE__ */ jsx(StationKey, { children: "Log" }),
          /* @__PURE__ */ jsx(StationVal, { children: /* @__PURE__ */ jsx(
            "a",
            {
              href: safeUrl(basics.url),
              target: "_blank",
              rel: "noopener noreferrer",
              children: basics.url.replace(/^https?:\/\//, "").replace(/\/$/, "")
            }
          ) })
        ] }),
        (basics.profiles || []).map(
          (p2, i) => p2.url ? /* @__PURE__ */ jsxs(StationCell, { children: [
            /* @__PURE__ */ jsx(StationKey, { children: p2.network || "Profile" }),
            /* @__PURE__ */ jsx(StationVal, { children: /* @__PURE__ */ jsx(
              "a",
              {
                href: safeUrl(p2.url),
                target: "_blank",
                rel: "noopener noreferrer",
                children: p2.username || p2.url.replace(/^https?:\/\//, "").replace(/\/$/, "")
              }
            ) })
          ] }, `profile-${i}`) : null
        )
    ...
    work.length > 0 && /* @__PURE__ */ jsxs(LogSection, { children: [
      /* @__PURE__ */ jsxs(LogHeading, { children: [
        /* @__PURE__ */ jsx(LogIndex, { children: nextIndex() }),
        /* @__PURE__ */ jsx(LogTitle, { children: "Field Observations" })
      ] }),
      work.map((job, index) => /* @__PURE__ */ jsxs(Entry, { children: [
        /* @__PURE__ */ jsxs(Margin, { children: [
          /* @__PURE__ */ jsx(DateTag, { children: /* @__PURE__ */ jsx(DateRange, { startDate: job.startDate, endDate: endOf(job) }) }),
          job.location && /* @__PURE__ */ jsx(MarginMeta, { children: job.location })
        ] }),
        /* @__PURE__ */ jsxs(Body, { children: [
          /* @__PURE__ */ jsx(EntryTitle, { children: job.url ? /* @__PURE__ */ jsx(Link, { href: safeUrl(job.url), children: job.position || job.name }) : job.position || job.name }),
          job.position && job.name && /* @__PURE__ */ jsx(EntrySubtitle, { children: job.name }),
          job.summary && /* @__PURE__ */ jsx(EntryText, { children: job.summary }),
          job.highlights && job.highlights.length > 0 && /* @__PURE__ */ jsx(Findings, { children: job.highlights.map((h, i) => /* @__PURE__ */ jsx("li", { children: h }, i)) })
        ] })
      ] }, index))
    ] }),
    projects.length > 0 && /* @__PURE__ */ jsxs(LogSection, { children: [
      /* @__PURE__ */ jsxs(LogHeading, { children: [
        /* @__PURE__ */ jsx(LogIndex, { children: nextIndex() }),
        /* @__PURE__ */ jsx(LogTitle, { children: "Field Studies" })
      ] }),
      projects.map((project, index) => /* @__PURE__ */ jsxs(Entry, { children: [
        /* @__PURE__ */ jsxs(Margin, { children: [
          /* @__PURE__ */ jsx(DateTag, { children: /* @__PURE__ */ jsx(
            DateRange,
            {
          ...
          project.type && /* @__PURE__ */ jsx(MarginMeta, { children: project.type })
        ] }),
        /* @__PURE__ */ jsxs(Body, { children: [
          /* @__PURE__ */ jsx(EntryTitle, { children: project.url ? /* @__PURE__ */ jsx(Link, { href: safeUrl(project.url), children: project.name }) : project.name }),
          project.description && /* @__PURE__ */ jsx(EntryText, { children: project.description }),
          project.highlights && project.highlights.length > 0 && /* @__PURE__ */ jsx(Findings, { children: project.highlights.map((h, i) => /* @__PURE__ */ jsx("li", { children: h }, i)) }),
          project.keywords && project.keywords.length > 0 && /* @__PURE__ */ jsx(Keywords, { children: project.keywords.map((k2, i) => /* @__PURE__ */ jsx(Tag, { children: k2 }, i)) })
        ] })
      ] }, index))
    ] }),
    education.length > 0 && /* @__PURE__ */ jsxs(LogSection, { children: [
      /* @__PURE__ */ jsxs(LogHeading, { children: [
        /* @__PURE__ */ jsx(LogIndex, { children: nextIndex() }),
        /* @__PURE__ */ jsx(LogTitle, { children: "Training & Education" })
      ] }),
      education.map((edu, index) => /* @__PURE__ */ jsxs(Entry, { children: [
        /* @__PURE__ */ jsxs(Margin, { children: [
          /* @__PURE__ */ jsx(DateTag, { children: /* @__PURE__ */ jsx(DateRange, { startDate: edu.startDate, endDate: endOf(edu) }) }),
          edu.score && /* @__PURE__ */ jsxs(MarginMeta, { children: [
            "GPA ",
            edu.score
          ] })
        ] }),
        /* @__PURE__ */ jsxs(Body, { children: [
          /* @__PURE__ */ jsx(EntryTitle, { children: edu.url ? /* @__PURE__ */ jsx(Link, { href: safeUrl(edu.url), children: edu.institution }) : edu.institution }),
          (edu.studyType || edu.area) && /* @__PURE__ */ jsx(EntrySubtitle, { children: [edu.studyType, edu.area].filter(Boolean).join(", ") }),
          edu.courses && edu.courses.length > 0 && /* @__PURE__ */ jsx(Findings, { children: edu.courses.map((c, i) => /* @__PURE__ */ jsx("li", { children: c }, i)) })
        ] })
      ] }, index))
    ] }),
    volunteer.length > 0 && /* @__PURE__ */ jsxs(LogSection, { children: [
      /* @__PURE__ */ jsxs(LogHeading, { children: [
        /* @__PURE__ */ jsx(LogIndex, { children: nextIndex() }),
        /* @__PURE__ */ jsx(LogTitle, { children: "Field Service" })
      ] }),
      volunteer.map((vol, index) => /* @__PURE__ */ jsxs(Entry, { children: [
        /* @__PURE__ */ jsx(Margin, { children: /* @__PURE__ */ jsx(DateTag, { children: /* @__PURE__ */ jsx(DateRange, { startDate: vol.startDate, endDate: endOf(vol) }) }) }),
        /* @__PURE__ */ jsxs(Body, { children: [
          /* @__PURE__ */ jsx(EntryTitle, { children: vol.url ? /* @__PURE__ */ jsx(Link, { href: safeUrl(vol.url), children: vol.position || vol.organization }) : vol.position || vol.organization }),
          vol.position && vol.organization && /* @__PURE__ */ jsx(EntrySubtitle, { children: vol.organization }),
          vol.summary && /* @__PURE__ */ jsx(EntryText, { children: vol.summary }),
          vol.highlights && vol.highlights.length > 0 && /* @__PURE__ */ jsx(Findings, { children: vol.highlights.map((h, i) => /* @__PURE__ */ jsx("li", { children: h }, i)) })
        ] })
      ] }, index))
    ] }),
    skills.length > 0 && /* @__PURE__ */ jsxs(LogSection, { children: [
      /* @__PURE__ */ jsxs(LogHeading, { children: [
        /* @__PURE__ */ jsx(LogIndex, { children: nextIndex() }),
        /* @__PURE__ */ jsx(LogTitle, { children: "Instruments & Methods" })
      ] }),
      /* @__PURE__ */ jsx(SpecimenGrid, { children: skills.map((skill, index) => /* @__PURE__ */ jsxs(Specimen, { children: [
        /* @__PURE__ */ jsxs(SpecimenName, { children: [
          skill.name,
          skill.level ? ` · ${skill.level}` : ""
        ] }),
        skill.keywords && skill.keywords.length > 0 && /* @__PURE__ */ jsx(StyledBadgeList, { children: skill.keywords.map((k2, i) => /* @__PURE__ */ jsx(StyledBadge, { children: k2 }, i)) })
      ] }, index)) })
    ] }),
    publications.length > 0 && /* @__PURE__ */ jsxs(LogSection, { children: [
      /* @__PURE__ */ jsxs(LogHeading, { children: [
        /* @__PURE__ */ jsx(LogIndex, { children: nextIndex() }),
        /* @__PURE__ */ jsx(LogTitle, { children: "Publications" })
      ] }),
      /* @__PURE__ */ jsx(Ledger, { children: publications.map((pub, index) => /* @__PURE__ */ jsxs(LedgerRow, { children: [
        /* @__PURE__ */ jsx(LedgerMeta, { children: [pub.publisher, pub.releaseDate].filter(Boolean).join(" · ") }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(LedgerTitle, { children: pub.url ? /* @__PURE__ */ jsx(Link, { href: safeUrl(pub.url), children: pub.name }) : pub.name }),
          pub.summary && /* @__PURE__ */ jsx(LedgerText, { children: pub.summary })
        ] })
      ] }, index)) })
    ] }),
    awards.length > 0 && /* @__PURE__ */ jsxs(LogSection, { children: [
      /* @__PURE__ */ jsxs(LogHeading, { children: [
        /* @__PURE__ */ jsx(LogIndex, { children: nextIndex() }),
        /* @__PURE__ */ jsx(LogTitle, { children: "Distinctions" })
      ] }),
      /* @__PURE__ */ jsx(Ledger, { children: awards.map((award, index) => /* @__PURE__ */ jsxs(LedgerRow, { children: [
        /* @__PURE__ */ jsx(LedgerMeta, { children: award.date }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(LedgerTitle, { children: award.title }),
          award.awarder && /* @__PURE__ */ jsxs(LedgerText, { children: [
            award.awarder,
    ...
    certificates.length > 0 && /* @__PURE__ */ jsxs(LogSection, { children: [
      /* @__PURE__ */ jsxs(LogHeading, { children: [
        /* @__PURE__ */ jsx(LogIndex, { children: nextIndex() }),
        /* @__PURE__ */ jsx(LogTitle, { children: "Certifications" })
      ] }),
      /* @__PURE__ */ jsx(Ledger, { children: certificates.map((cert, index) => /* @__PURE__ */ jsxs(LedgerRow, { children: [
        /* @__PURE__ */ jsx(LedgerMeta, { children: cert.date }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(LedgerTitle, { children: cert.url ? /* @__PURE__ */ jsx(Link, { href: safeUrl(cert.url), children: cert.name }) : cert.name }),
          cert.issuer && /* @__PURE__ */ jsx(LedgerText, { children: cert.issuer })
        ] })
      ] }, index)) })
    ] }),
    languages.length > 0 && /* @__PURE__ */ jsxs(LogSection, { children: [
      /* @__PURE__ */ jsxs(LogHeading, { children: [
        /* @__PURE__ */ jsx(LogIndex, { children: nextIndex() }),
        /* @__PURE__ */ jsx(LogTitle, { children: "Languages" })
      ] }),
      /* @__PURE__ */ jsx(LangGrid, { children: languages.map((lang, index) => /* @__PURE__ */ jsxs(LangItem, { children: [
        /* @__PURE__ */ jsx("span", { className: "lang", children: lang.language }),
        lang.fluency && /* @__PURE__ */ jsx("span", { className: "fluency", children: lang.fluency })
      ] }, index)) })
    ] }),
    interests.length > 0 && /* @__PURE__ */ jsxs(LogSection, { children: [
      /* @__PURE__ */ jsxs(LogHeading, { children: [
        /* @__PURE__ */ jsx(LogIndex, { children: nextIndex() }),
        /* @__PURE__ */ jsx(LogTitle, { children: "Field Interests" })
      ] }),
      /* @__PURE__ */ jsx(SpecimenGrid, { children: interests.map((interest, index) => /* @__PURE__ */ jsxs(Specimen, { children: [
        /* @__PURE__ */ jsx(SpecimenName, { children: interest.name }),
        interest.keywords && interest.keywords.length > 0 && /* @__PURE__ */ jsx(StyledBadgeList, { children: interest.keywords.map((k2, i) => /* @__PURE__ */ jsx(StyledBadge, { children: k2 }, i)) })
      ] }, index)) })
    ] }),
    references.length > 0 && /* @__PURE__ */ jsxs(LogSection, { children: [
      /* @__PURE__ */ jsxs(LogHeading, { children: [
        /* @__PURE__ */ jsx(LogIndex, { children: nextIndex() }),
        /* @__PURE__ */ jsx(LogTitle, { children: "Field Correspondents" })
      ] }),
      /* @__PURE__ */ jsx(Ledger, { children: references.map((ref, index) => /* @__PURE__ */ jsxs(LedgerRow, { children: [
        /* @__PURE__ */ jsxs(LedgerMeta, { children: [
          "Ref. ",
          pad(index + 1)
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(LedgerTitle, { children: ref.name }),
          ref.reference && /* @__PURE__ */ jsxs(LedgerText, { children: [
            "“",
            ref.reference,
            "”"
          ] })
    ...
    /* @__PURE__ */ jsxs(Coda, { children: [
      /* @__PURE__ */ jsx("span", { children: "End of Record" }),
      basics.name && /* @__PURE__ */ jsx("span", { children: basics.name })
    ] })
  ] });
}
