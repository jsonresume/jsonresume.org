...
function Avatar({
  ...
  if (!src && !fallback) {
    return /* @__PURE__ */ jsx(Placeholder, { $size: size, $rounded: rounded, className, children: alt?.[0]?.toUpperCase() || "?" });
  }
  return /* @__PURE__ */ jsx(
    Image,
    {
...
const StyledBadge = dt(Badge)`
  ...
  color: ${INK_SOFT};
`;
const CardList = dt.div`
  display: grid;
  grid-template-columns: ${(p2) => p2.$two ? "repeat(2, 1fr)" : "1fr"};
  gap: 16px;
...
function fmtDate(value) {
  ...
  const m2 = /^(\d{4})(?:-(\d{2}))?/.exec(String(value));
  if (!m2) return value;
  const year = m2[1];
...
function Entry({ date, meta, title, href, subtitle, text, highlights }) {
  return /* @__PURE__ */ jsxs(Entry$1, { children: [
    ...
    /* @__PURE__ */ jsxs(Body, { children: [
      /* @__PURE__ */ jsx(EntryTitle, { children: href ? /* @__PURE__ */ jsx(Link, { href: safeUrl(href), children: title }) : title }),
      subtitle && /* @__PURE__ */ jsx(EntrySubtitle, { children: subtitle }),
      text && /* @__PURE__ */ jsx(EntryText, { children: text }),
      /* @__PURE__ */ jsx(Findings, { items: highlights })
    ] })
  ] });
}
  ...
  return /* @__PURE__ */ jsxs(Layout, { children: [
    /* @__PURE__ */ jsxs(Header, { children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(Eyebrow, { children: "Field Dossier" }),
    ...
    work.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      work.map((job, i) => /* @__PURE__ */ jsx(
        Entry,
        {
          date: /* @__PURE__ */ jsx(DateRange, { startDate: job.startDate, endDate: job.endDate }),
          meta: job.location,
    ...
    projects.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      projects.map((p2, i) => /* @__PURE__ */ jsx(
        Entry,
        {
          date: /* @__PURE__ */ jsx(DateRange, { startDate: p2.startDate, endDate: p2.endDate }),
          meta: p2.type || p2.keywords && p2.keywords[0],
          title: p2.name,
          href: p2.url,
          text: p2.description,
    ...
    education.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      education.map((e, i) => /* @__PURE__ */ jsx(
        Entry,
        {
          date: /* @__PURE__ */ jsx(DateRange, { startDate: e.startDate, endDate: e.endDate }),
          meta: e.score ? `GPA ${e.score}` : null,
          title: e.institution,
          href: e.url,
          subtitle: [e.studyType, e.area].filter(Boolean).join(", ") || null,
    ...
    volunteer.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      volunteer.map((v2, i) => /* @__PURE__ */ jsx(
        Entry,
        {
          date: /* @__PURE__ */ jsx(DateRange, { startDate: v2.startDate, endDate: v2.endDate }),
          meta: v2.url ? "Organization" : null,
          title: v2.position,
          href: v2.url,
          subtitle: v2.organization,
          text: v2.summary,
