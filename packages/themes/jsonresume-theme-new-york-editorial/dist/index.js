...
const StyledDateRange$1 = dt.span`
  font-size: ${(props) => props.theme?.typography?.small || "var(--resume-size-small, 10pt)"};
  color: ${(props) => props.theme?.colors?.tertiary || "var(--resume-color-tertiary, #666)"};
  white-space: nowrap;
`;
...
`;
const EducationItem = dt.article`
  margin-bottom: 36px;
...
const SkillName = dt.h4`
  ...
  display: inline-block;
`;
const KeywordList = dt.p`
  font-size: 15px;
  color: #555555;
  line-height: 1.7;
  margin: 0;
`;
const ProjectItem = dt.article`
  margin-bottom: 40px;
...
function Resume({ resume }) {
  ...
  return /* @__PURE__ */ jsxs(Layout, { children: [
    ...
    work && work.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      work.map((job, index) => /* @__PURE__ */ jsxs(WorkItem, { children: [
        /* @__PURE__ */ jsxs(WorkHeader, { children: [
          ...
          /* @__PURE__ */ jsxs(CompanyLine, { children: [
            /* @__PURE__ */ jsx(Company, { children: job.name }),
            /* @__PURE__ */ jsx(
              StyledDateRange,
              {
        ...
        job.highlights && job.highlights.length > 0 && /* @__PURE__ */ jsx(HighlightsList, { children: job.highlights.map((highlight, i) => /* @__PURE__ */ jsx(
          "li",
          {
    ...
    skills && skills.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Expertise" }),
      /* @__PURE__ */ jsx(SkillsContainer, { children: skills.map((skill, index) => /* @__PURE__ */ jsxs(SkillGroup, { children: [
    ...
    education && education.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Education" }),
      education.map((edu, index) => /* @__PURE__ */ jsxs(EducationItem, { children: [
        /* @__PURE__ */ jsx(Degree, { children: edu.area }),
        /* @__PURE__ */ jsxs(InstitutionLine, { children: [
        ...
        edu.studyType && /* @__PURE__ */ jsx(StudyType, { children: edu.studyType }),
        edu.score && /* @__PURE__ */ jsxs(ItemMeta, { children: [
          "GPA: ",
          edu.score
        ] })
      ] }, index))
    ] }),
    projects && projects.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Projects" }),
      projects.map((project, index) => /* @__PURE__ */ jsxs(ProjectItem, { children: [
        /* @__PURE__ */ jsx(ProjectName, { children: project.url ? /* @__PURE__ */ jsx(Link, { href: project.url, children: project.name }) : project.name }),
        project.description && /* @__PURE__ */ jsx(ProjectDescription, { children: project.description }),
        project.highlights && project.highlights.length > 0 && /* @__PURE__ */ jsx(ProjectHighlights, { children: project.highlights.map((highlight, i) => /* @__PURE__ */ jsx("li", { children: highlight }, i)) })
      ] }, index))
    ] }),
    publications && publications.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      publications.map((pub, index) => /* @__PURE__ */ jsxs(ProjectItem, { children: [
        /* @__PURE__ */ jsx(ProjectName, { children: pub.url ? /* @__PURE__ */ jsx(Link, { href: pub.url, children: pub.name }) : pub.name }),
        /* @__PURE__ */ jsxs(ItemMeta, { children: [
          pub.publisher,
          pub.releaseDate && /* @__PURE__ */ jsxs(Fragment, { children: [
            " • ",
            pub.releaseDate
          ] })
        ] }),
        pub.summary && /* @__PURE__ */ jsx(ProjectDescription, { children: pub.summary })
      ] }, index))
    ] }),
    volunteer && volunteer.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Volunteer Work" }),
      /* @__PURE__ */ jsx(SimpleList, { children: volunteer.map((vol, index) => /* @__PURE__ */ jsxs(SimpleItem, { children: [
        /* @__PURE__ */ jsx(ItemTitle, { children: vol.position }),
        /* @__PURE__ */ jsxs(ItemMeta, { children: [
          vol.organization,
          vol.startDate && /* @__PURE__ */ jsxs(Fragment, { children: [
            " • ",
            /* @__PURE__ */ jsx(
              DateRange,
              {
        ...
        vol.summary && /* @__PURE__ */ jsx(ItemDescription, { children: vol.summary })
      ] }, index)) })
    ] }),
    awards && awards.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Awards & Honors" }),
      /* @__PURE__ */ jsx(SimpleList, { children: awards.map((award, index) => /* @__PURE__ */ jsxs(SimpleItem, { children: [
        /* @__PURE__ */ jsx(ItemTitle, { children: award.title }),
        /* @__PURE__ */ jsxs(ItemMeta, { children: [
          award.awarder,
          award.date && /* @__PURE__ */ jsxs(Fragment, { children: [
            " • ",
            award.date
          ] })
        ] }),
    ...
    languages && languages.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      /* @__PURE__ */ jsx(SkillsContainer, { children: languages.map((lang, index) => /* @__PURE__ */ jsxs(SkillGroup, { children: [
        /* @__PURE__ */ jsx(SkillName, { children: lang.language }),
        lang.fluency && /* @__PURE__ */ jsx(KeywordList, { children: lang.fluency })
      ] }, index)) })
    ] }),
    interests && interests.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Interests" }),
      /* @__PURE__ */ jsx(SkillsContainer, { children: interests.map((interest, index) => /* @__PURE__ */ jsxs(SkillGroup, { children: [
        /* @__PURE__ */ jsx(SkillName, { children: interest.name }),
        interest.keywords && interest.keywords.length > 0 && /* @__PURE__ */ jsx(KeywordList, { children: interest.keywords.join(", ") })
      ] }, index)) })
    ] }),
    references && references.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "References" }),
      /* @__PURE__ */ jsx(SimpleList, { children: references.map((ref, index) => /* @__PURE__ */ jsxs(SimpleItem, { children: [
        /* @__PURE__ */ jsx(ItemTitle, { children: ref.name }),
        ref.reference && /* @__PURE__ */ jsx(ItemDescription, { children: ref.reference })
      ] }, index)) })
    ] })
  ] });
}
...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Merriweather:ital,wght@0,400;0,700;0,900;1,400&family=Source+Sans+Pro:wght@400;600&display=swap" rel="stylesheet">
  ${styles}
</head>
<body>${html}</body>
</html>`;
