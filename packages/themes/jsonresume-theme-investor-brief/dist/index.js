...
function Resume({ resume }) {
    ...
    if (work.length > 0) {
      const totalYears = work.reduce((acc, job) => {
        if (job.startDate) {
          ...
          const end = job.endDate ? new Date(job.endDate) : /* @__PURE__ */ new Date();
          const years = (end - start) / (1e3 * 60 * 60 * 24 * 365);
          return acc + years;
        }
        return acc;
      }, 0);
  ...
  return /* @__PURE__ */ jsxs(Layout, { children: [
    ...
    keyMetrics.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
      /* @__PURE__ */ jsx(MainSectionTitle, { children: "Key Metrics" }),
      /* @__PURE__ */ jsx(MetricsGrid, { children: keyMetrics.map((metric, index) => /* @__PURE__ */ jsxs(MetricCard, { children: [
        /* @__PURE__ */ jsx(MetricLabel, { children: metric.label }),
        /* @__PURE__ */ jsx(MetricValue, { children: metric.value })
      ] }, index)) })
    ] }),
    ...
    awards.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
      ...
      /* @__PURE__ */ jsx(SimpleList, { children: awards.map((award, index) => /* @__PURE__ */ jsxs(SimpleCard, { children: [
    ...
    publications.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
      ...
      /* @__PURE__ */ jsx(SimpleList, { children: publications.map((pub, index) => /* @__PURE__ */ jsxs(SimpleCard, { children: [
