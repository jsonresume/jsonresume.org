...
`;
const TitleBlock = dt.header`
  display: grid;
  grid-template-columns: ${(p2) => p2.$hasImage ? "96px 1fr" : "1fr"};
  gap: 20px;
  align-items: stretch;
...
`;
const SpecBar = dt.div`
  display: grid;
  grid-template-columns: repeat(auto-fit, minmax(190px, 1fr));
  border-bottom: 2px solid ${BLUE};
`;
const SpecCell = dt.div`
  padding: 8px 14px;
...
`;
const SectionHead = dt.div`
  display: flex;
  align-items: center;
  gap: 12px;
  margin-bottom: 16px;
`;
const PartNo = dt.span`
  font-family: ${MONO};
  font-size: 11px;
  font-weight: 700;
  color: #fff;
...
const MetaTag = dt.div`
  ...
  color: ${MUTE};
`;
const RecordBody = dt.div`
  padding: 12px 16px;
  min-width: 0;
`;
const RoleTitle = dt.h3`
  font-size: 15px;
  font-weight: 700;
  margin: 0;
  color: ${INK};
...
const SummaryText = dt.p`
  ...
  margin: 0;
`;
const SkillMatrix = dt.div`
  display: grid;
  grid-template-columns: repeat(auto-fill, minmax(250px, 1fr));
  gap: 10px;
`;
const SkillCell = dt.div`
  border: 1px solid ${GRID};
...
function SectionHeader({ no, title }) {
  return /* @__PURE__ */ jsxs(SectionHead, { children: [
    /* @__PURE__ */ jsx(PartNo, { children: no }),
    /* @__PURE__ */ jsx(SectionTitle, { children: title }),
    /* @__PURE__ */ jsx(DimLine, { "aria-hidden": "true" })
  ] });
}
function Resume({ resume }) {
  ...
  if (basics.email)
    contactItems.push({
      k: "E-MAIL",
      v: /* @__PURE__ */ jsx("a", { href: safeUrl(`mailto:${basics.email}`), children: basics.email })
    });
  if (basics.phone)
    contactItems.push({
      k: "PHONE",
      v: /* @__PURE__ */ jsx("a", { href: safeUrl(`tel:${basics.phone}`), children: basics.phone })
    });
  if (loc) contactItems.push({ k: "LOCATION", v: loc });
  if (basics.url)
    contactItems.push({
      k: "WEB",
      v: /* @__PURE__ */ jsx("a", { href: safeUrl(basics.url), target: "_blank", rel: "noopener noreferrer", children: basics.url.replace(/^https?:\/\//, "").replace(/\/$/, "") })
    });
  (basics.profiles || []).forEach((p2) => {
    if (!p2) return;
    contactItems.push({
      k: p2.network || "PROFILE",
      v: p2.url ? /* @__PURE__ */ jsx("a", { href: safeUrl(p2.url), target: "_blank", rel: "noopener noreferrer", children: p2.username || p2.network }) : p2.username || ""
    });
  });
  let part = 0;
  const next2 = () => pad(++part);
  return /* @__PURE__ */ jsx(Sheet, { children: /* @__PURE__ */ jsxs(Frame, { children: [
    /* @__PURE__ */ jsx(CornerTick, { className: "tl" }),
    /* @__PURE__ */ jsx(CornerTick, { className: "tr" }),
    /* @__PURE__ */ jsx(CornerTick, { className: "bl" }),
    /* @__PURE__ */ jsx(CornerTick, { className: "br" }),
    /* @__PURE__ */ jsxs(TitleBlock, { $hasImage: Boolean(basics.image), children: [
      basics.image && /* @__PURE__ */ jsx(Portrait, { src: basics.image, alt: basics.name }),
      /* @__PURE__ */ jsxs(TitleMain, { children: [
        /* @__PURE__ */ jsxs(DocTag, { children: [
          /* @__PURE__ */ jsxs("span", { children: [
            "DOC-NO / ",
            (basics.name || "RESUME").slice(0, 3).toUpperCase(),
            "-001"
          ] }),
          /* @__PURE__ */ jsx("span", { children: "REV / A" }),
          /* @__PURE__ */ jsx("span", { children: "SHEET 1 OF 1" })
        ] }),
        basics.name && /* @__PURE__ */ jsx(Name, { children: basics.name }),
        basics.label && /* @__PURE__ */ jsx(Label, { children: basics.label })
      ] })
    ] }),
    contactItems.length > 0 && /* @__PURE__ */ jsx(SpecBar, { children: contactItems.map((it2, i) => /* @__PURE__ */ jsxs(SpecCell, { children: [
      /* @__PURE__ */ jsx(SpecKey, { children: it2.k }),
      /* @__PURE__ */ jsx(SpecVal, { children: it2.v })
    ] }, i)) }),
    /* @__PURE__ */ jsxs(Body, { children: [
      basics.summary && /* @__PURE__ */ jsxs(SummaryBlock, { children: [
        /* @__PURE__ */ jsx(SummaryLabel, { children: "Notes — Profile" }),
        /* @__PURE__ */ jsx(SummaryText, { children: basics.summary })
      ] }),
      work.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
        /* @__PURE__ */ jsx(SectionHeader, { no: next2(), title: "Experience" }),
        work.map((job, i) => /* @__PURE__ */ jsxs(Record, { children: [
          /* @__PURE__ */ jsxs(RecordMeta, { children: [
            /* @__PURE__ */ jsx(MetaDate, { children: /* @__PURE__ */ jsx(
              DateRange,
              {
            ...
            job.location && /* @__PURE__ */ jsx(MetaTag, { children: job.location })
          ] }),
          /* @__PURE__ */ jsxs(RecordBody, { children: [
            /* @__PURE__ */ jsx(RoleTitle, { children: job.url ? /* @__PURE__ */ jsx(
              "a",
              {
                href: safeUrl(job.url),
                target: "_blank",
                rel: "noopener noreferrer",
                children: job.position || job.name
              }
            ) : job.position || job.name }),
            job.name && job.position && /* @__PURE__ */ jsx(RoleOrg, { children: job.name }),
            job.summary && /* @__PURE__ */ jsx(Para, { children: job.summary }),
            job.highlights && job.highlights.length > 0 && /* @__PURE__ */ jsx(Highlights, { children: job.highlights.map((h, j2) => /* @__PURE__ */ jsx("li", { children: h }, j2)) })
          ] })
        ] }, i))
      ] }),
      projects.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
        /* @__PURE__ */ jsx(SectionHeader, { no: next2(), title: "Projects" }),
        projects.map((proj, i) => /* @__PURE__ */ jsxs(Record, { children: [
          /* @__PURE__ */ jsxs(RecordMeta, { children: [
            /* @__PURE__ */ jsx(MetaDate, { children: /* @__PURE__ */ jsx(
              DateRange,
              {
            ...
            proj.type && /* @__PURE__ */ jsx(MetaTag, { children: proj.type })
          ] }),
          /* @__PURE__ */ jsxs(RecordBody, { children: [
            /* @__PURE__ */ jsx(RoleTitle, { children: proj.url ? /* @__PURE__ */ jsx(
              "a",
              {
            ...
            proj.entity && /* @__PURE__ */ jsx(RoleOrg, { children: proj.entity }),
            proj.description && /* @__PURE__ */ jsx(Para, { children: proj.description }),
            proj.highlights && proj.highlights.length > 0 && /* @__PURE__ */ jsx(Highlights, { children: proj.highlights.map((h, j2) => /* @__PURE__ */ jsx("li", { children: h }, j2)) })
          ] })
        ] }, i))
      ] }),
      education.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
        /* @__PURE__ */ jsx(SectionHeader, { no: next2(), title: "Education" }),
        education.map((edu, i) => /* @__PURE__ */ jsxs(Record, { children: [
          /* @__PURE__ */ jsxs(RecordMeta, { children: [
            /* @__PURE__ */ jsx(MetaDate, { children: /* @__PURE__ */ jsx(
              DateRange,
              {
            ...
            edu.score && /* @__PURE__ */ jsxs(MetaTag, { children: [
              "GPA ",
              edu.score
            ] })
          ] }),
          /* @__PURE__ */ jsxs(RecordBody, { children: [
            /* @__PURE__ */ jsx(RoleTitle, { children: edu.institution }),
            (edu.studyType || edu.area) && /* @__PURE__ */ jsx(RoleOrg, { children: [edu.studyType, edu.area].filter(Boolean).join(" — ") }),
            edu.courses && edu.courses.length > 0 && /* @__PURE__ */ jsx(Highlights, { children: edu.courses.map((c, j2) => /* @__PURE__ */ jsx("li", { children: c }, j2)) })
          ] })
        ] }, i))
      ] }),
      skills.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
        /* @__PURE__ */ jsx(SectionHeader, { no: next2(), title: "Skills" }),
        /* @__PURE__ */ jsx(SkillMatrix, { children: skills.map((skill, i) => /* @__PURE__ */ jsxs(SkillCell, { children: [
          /* @__PURE__ */ jsxs(SkillName, { children: [
            skill.name,
            skill.level && /* @__PURE__ */ jsx("span", { children: skill.level })
          ] }),
          skill.keywords && skill.keywords.length > 0 && /* @__PURE__ */ jsx(ChipRow, { children: skill.keywords.map((kw, j2) => /* @__PURE__ */ jsx(Chip, { children: kw }, j2)) })
        ] }, i)) })
      ] }),
      volunteer.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
        /* @__PURE__ */ jsx(SectionHeader, { no: next2(), title: "Volunteer" }),
        volunteer.map((vol, i) => /* @__PURE__ */ jsxs(Record, { children: [
          /* @__PURE__ */ jsx(RecordMeta, { children: /* @__PURE__ */ jsx(MetaDate, { children: /* @__PURE__ */ jsx(
            DateRange,
            {
          ...
          /* @__PURE__ */ jsxs(RecordBody, { children: [
            /* @__PURE__ */ jsx(RoleTitle, { children: vol.url ? /* @__PURE__ */ jsx(
              "a",
              {
                href: safeUrl(vol.url),
                target: "_blank",
                rel: "noopener noreferrer",
                children: vol.position
              }
            ) : vol.position }),
            vol.organization && /* @__PURE__ */ jsx(RoleOrg, { children: vol.organization }),
            vol.summary && /* @__PURE__ */ jsx(Para, { children: vol.summary }),
            vol.highlights && vol.highlights.length > 0 && /* @__PURE__ */ jsx(Highlights, { children: vol.highlights.map((h, j2) => /* @__PURE__ */ jsx("li", { children: h }, j2)) })
          ] })
        ] }, i))
      ] }),
      awards.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
        /* @__PURE__ */ jsx(SectionHeader, { no: next2(), title: "Awards" }),
        /* @__PURE__ */ jsx(CardGrid, { children: awards.map((a, i) => /* @__PURE__ */ jsxs(Card, { children: [
          /* @__PURE__ */ jsx("h4", { children: a.title }),
          /* @__PURE__ */ jsx("div", { className: "src", children: [a.awarder, a.date].filter(Boolean).join(" / ") }),
          a.summary && /* @__PURE__ */ jsx("p", { children: a.summary })
        ] }, i)) })
      ] }),
      certificates.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
        /* @__PURE__ */ jsx(SectionHeader, { no: next2(), title: "Certificates" }),
        /* @__PURE__ */ jsx(CardGrid, { children: certificates.map((c, i) => /* @__PURE__ */ jsxs(Card, { children: [
          /* @__PURE__ */ jsx("h4", { children: c.url ? /* @__PURE__ */ jsx(
            "a",
            {
              href: safeUrl(c.url),
              target: "_blank",
          ...
          /* @__PURE__ */ jsx("div", { className: "src", children: [c.issuer, c.date].filter(Boolean).join(" / ") })
        ] }, i)) })
      ] }),
      publications.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
        /* @__PURE__ */ jsx(SectionHeader, { no: next2(), title: "Publications" }),
        /* @__PURE__ */ jsx(CardGrid, { children: publications.map((p2, i) => /* @__PURE__ */ jsxs(Card, { children: [
          /* @__PURE__ */ jsx("h4", { children: p2.url ? /* @__PURE__ */ jsx(
            "a",
            {
              href: safeUrl(p2.url),
              target: "_blank",
          ...
          /* @__PURE__ */ jsx("div", { className: "src", children: [p2.publisher, p2.releaseDate].filter(Boolean).join(" / ") }),
          p2.summary && /* @__PURE__ */ jsx("p", { children: p2.summary })
        ] }, i)) })
      ] }),
      languages.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
        /* @__PURE__ */ jsx(SectionHeader, { no: next2(), title: "Languages" }),
        /* @__PURE__ */ jsx(InlineList, { children: languages.map((l, i) => /* @__PURE__ */ jsxs(InlineItem, { children: [
          /* @__PURE__ */ jsx("b", { children: l.language }),
          l.fluency && /* @__PURE__ */ jsx("small", { children: l.fluency })
        ] }, i)) })
      ] }),
      interests.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
        /* @__PURE__ */ jsx(SectionHeader, { no: next2(), title: "Interests" }),
        /* @__PURE__ */ jsx(CardGrid, { children: interests.map((it2, i) => /* @__PURE__ */ jsxs(Card, { children: [
      ...
      references.length > 0 && /* @__PURE__ */ jsxs(Section, { children: [
        /* @__PURE__ */ jsx(SectionHeader, { no: next2(), title: "References" }),
        /* @__PURE__ */ jsx(CardGrid, { children: references.map((r, i) => /* @__PURE__ */ jsxs(Card, { children: [
    ...
    /* @__PURE__ */ jsxs(Footer, { children: [
      /* @__PURE__ */ jsx("span", { children: basics.name ? `${basics.name} // CURRICULUM VITAE` : "CURRICULUM VITAE" }),
      /* @__PURE__ */ jsx("span", { children: "JSON-RESUME / INDUSTRIAL-ENGINEER" })
    ] })
  ] }) });
}
