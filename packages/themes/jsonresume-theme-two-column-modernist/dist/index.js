...
`;
const SidebarSection = dt.section`
  display: flex;
  flex-direction: column;
  gap: 1rem;
`;
...
const EntryMeta = dt.div`
  ...
  align-items: center;
`;
const EntryOrganization = dt.span`
  font-weight: 500;
  color: #4b5563;
`;
const EntryDate = dt.span`
  color: #9ca3af;
  font-size: 0.8rem;
`;
const EntryDescription = dt.p`
  font-size: 0.9rem;
  line-height: 1.7;
  color: #374151;
  margin: 0;
...
function Header({ basics }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(HeaderContainer, { children: [
      ...
      basics.label && /* @__PURE__ */ jsx(Title, { children: basics.label })
    ] }),
    (basics.email || basics.phone || basics.url || basics.location) && /* @__PURE__ */ jsxs(Contact, { children: [
      basics.email && /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("a", { href: `mailto:${basics.email}`, children: basics.email }) }),
      basics.phone && /* @__PURE__ */ jsx("div", { children: basics.phone }),
      basics.url && /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
        "a",
        {
          href: safeUrl(basics.url),
          target: "_blank",
          rel: "noopener noreferrer",
          children: basics.url.replace(/^https?:\/\//, "")
        }
      ) }),
      basics.location && /* @__PURE__ */ jsx("div", { children: [
        basics.location.city,
        basics.location.region,
        basics.location.countryCode
      ].filter(Boolean).join(", ") })
    ] }),
    basics.profiles && basics.profiles.length > 0 && /* @__PURE__ */ jsx(Contact, { children: basics.profiles.map((profile, i) => /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs(
      "a",
      {
...
function Skills({ skills }) {
  ...
  return /* @__PURE__ */ jsxs(SidebarSection, { children: [
    /* @__PURE__ */ jsx(SidebarTitle, { children: "Skills" }),
    skills.map((skill, i) => /* @__PURE__ */ jsxs(SkillCategory, { children: [
      skill.name && /* @__PURE__ */ jsx(SkillName, { children: skill.name }),
      skill.keywords && skill.keywords.length > 0 && /* @__PURE__ */ jsx(SkillList, { children: skill.keywords.map((keyword, j2) => /* @__PURE__ */ jsx(SkillItem, { children: keyword }, j2)) })
    ] }, i))
  ] });
}
function Languages({ languages }) {
  ...
  return /* @__PURE__ */ jsxs(SidebarSection, { children: [
    /* @__PURE__ */ jsx(SidebarTitle, { children: "Languages" }),
    /* @__PURE__ */ jsx(LanguageList, { children: languages.map((lang, i) => /* @__PURE__ */ jsxs(LanguageItem, { children: [
      /* @__PURE__ */ jsx(LanguageName, { children: lang.language }),
      lang.fluency && /* @__PURE__ */ jsx(LanguageFluency, { children: lang.fluency })
    ] }, i)) })
  ] });
}
function SummarySection({ summary }) {
  if (!summary) return null;
  return /* @__PURE__ */ jsx(Section, { children: /* @__PURE__ */ jsx(Summary, { children: summary }) });
}
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    ...
    work.map((job, i) => /* @__PURE__ */ jsxs(Entry, { children: [
      /* @__PURE__ */ jsxs(EntryHeader, { children: [
        job.position && /* @__PURE__ */ jsx(EntryTitle, { children: job.position }),
        /* @__PURE__ */ jsxs(EntryMeta, { children: [
          job.name && /* @__PURE__ */ jsx(EntryOrganization, { children: job.name }),
          (job.startDate || job.endDate) && /* @__PURE__ */ jsx(EntryDate, { children: /* @__PURE__ */ jsx(DateRange, { startDate: job.startDate, endDate: job.endDate }) })
        ] })
      ] }),
      job.summary && /* @__PURE__ */ jsx(EntryDescription, { children: job.summary }),
      job.highlights && job.highlights.length > 0 && /* @__PURE__ */ jsx(HighlightsList, { children: job.highlights.map((highlight, j2) => /* @__PURE__ */ jsx(HighlightItem, { children: highlight }, j2)) })
    ] }, i))
  ] });
}
function EducationSection({ education }) {
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    /* @__PURE__ */ jsx(SectionTitle, { children: "Education" }),
    education.map((edu, i) => /* @__PURE__ */ jsxs(Entry, { children: [
      /* @__PURE__ */ jsxs(EntryHeader, { children: [
        edu.studyType && edu.area && /* @__PURE__ */ jsxs(EntryTitle, { children: [
          edu.studyType,
          " in ",
          edu.area
        ] }),
        /* @__PURE__ */ jsxs(EntryMeta, { children: [
          edu.institution && /* @__PURE__ */ jsx(EntryOrganization, { children: edu.institution }),
          (edu.startDate || edu.endDate) && /* @__PURE__ */ jsx(EntryDate, { children: /* @__PURE__ */ jsx(DateRange, { startDate: edu.startDate, endDate: edu.endDate }) })
        ] })
      ] }),
      edu.score && /* @__PURE__ */ jsxs(EntryDescription, { children: [
        "GPA: ",
        edu.score
      ] }),
      edu.courses && edu.courses.length > 0 && /* @__PURE__ */ jsx(HighlightsList, { children: edu.courses.map((course, j2) => /* @__PURE__ */ jsx(HighlightItem, { children: course }, j2)) })
    ] }, i))
  ] });
}
function ProjectsSection({ projects }) {
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    ...
    projects.map((project, i) => /* @__PURE__ */ jsxs(Entry, { children: [
      /* @__PURE__ */ jsxs(EntryHeader, { children: [
        project.name && /* @__PURE__ */ jsx(EntryTitle, { children: project.name }),
        (project.startDate || project.endDate) && /* @__PURE__ */ jsx(EntryMeta, { children: /* @__PURE__ */ jsx(EntryDate, { children: /* @__PURE__ */ jsx(
          DateRange,
          {
      ...
      project.description && /* @__PURE__ */ jsx(EntryDescription, { children: project.description }),
      project.highlights && project.highlights.length > 0 && /* @__PURE__ */ jsx(HighlightsList, { children: project.highlights.map((highlight, j2) => /* @__PURE__ */ jsx(HighlightItem, { children: highlight }, j2)) }),
      project.url && /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
        "a",
        {
...
function VolunteerSection({ volunteer }) {
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    ...
    volunteer.map((vol, i) => /* @__PURE__ */ jsxs(Entry, { children: [
      /* @__PURE__ */ jsxs(EntryHeader, { children: [
        vol.position && /* @__PURE__ */ jsx(EntryTitle, { children: vol.position }),
        /* @__PURE__ */ jsxs(EntryMeta, { children: [
          vol.organization && /* @__PURE__ */ jsx(EntryOrganization, { children: vol.organization }),
          (vol.startDate || vol.endDate) && /* @__PURE__ */ jsx(EntryDate, { children: /* @__PURE__ */ jsx(DateRange, { startDate: vol.startDate, endDate: vol.endDate }) })
        ] })
      ] }),
      vol.summary && /* @__PURE__ */ jsx(EntryDescription, { children: vol.summary }),
      vol.highlights && vol.highlights.length > 0 && /* @__PURE__ */ jsx(HighlightsList, { children: vol.highlights.map((highlight, j2) => /* @__PURE__ */ jsx(HighlightItem, { children: highlight }, j2)) })
    ] }, i))
  ] });
}
function AwardsSection({ awards }) {
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    ...
    awards.map((award, i) => /* @__PURE__ */ jsxs(Entry, { children: [
      /* @__PURE__ */ jsxs(EntryHeader, { children: [
        award.title && /* @__PURE__ */ jsx(EntryTitle, { children: award.title }),
        /* @__PURE__ */ jsxs(EntryMeta, { children: [
          award.awarder && /* @__PURE__ */ jsx(EntryOrganization, { children: award.awarder }),
          award.date && /* @__PURE__ */ jsx(EntryDate, { children: award.date })
        ] })
      ] }),
      award.summary && /* @__PURE__ */ jsx(EntryDescription, { children: award.summary })
    ] }, i))
  ] });
}
function PublicationsSection({ publications }) {
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    ...
    publications.map((pub, i) => /* @__PURE__ */ jsxs(Entry, { children: [
      /* @__PURE__ */ jsxs(EntryHeader, { children: [
        pub.name && /* @__PURE__ */ jsx(EntryTitle, { children: pub.name }),
        /* @__PURE__ */ jsxs(EntryMeta, { children: [
          pub.publisher && /* @__PURE__ */ jsx(EntryOrganization, { children: pub.publisher }),
          pub.releaseDate && /* @__PURE__ */ jsx(EntryDate, { children: pub.releaseDate })
        ] })
      ] }),
      pub.summary && /* @__PURE__ */ jsx(EntryDescription, { children: pub.summary }),
      pub.url && /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
        "a",
        {
...
function ReferencesSection({ references }) {
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    ...
    references.map((ref, i) => /* @__PURE__ */ jsxs(Entry, { children: [
      ref.name && /* @__PURE__ */ jsx(EntryTitle, { children: ref.name }),
      ref.reference && /* @__PURE__ */ jsx(EntryDescription, { children: ref.reference })
    ] }, i))
  ] });
}
function Resume({ resume }) {
  ...
  return /* @__PURE__ */ jsxs(Container, { children: [
    /* @__PURE__ */ jsxs(LeftColumn, { children: [
      ...
      (basics?.email || basics?.phone || basics?.url || basics?.location) && /* @__PURE__ */ jsx(Divider, {}),
      basics?.profiles && basics.profiles.length > 0 && /* @__PURE__ */ jsx(Divider, {}),
      skills && skills.length > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(Divider, {}),
        /* @__PURE__ */ jsx(Skills, { skills })
      ] }),
      languages && languages.length > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(Divider, {}),
        /* @__PURE__ */ jsx(Languages, { languages })
      ] })
    ] }),
    /* @__PURE__ */ jsxs(RightColumn, { children: [
      /* @__PURE__ */ jsx(SummarySection, { summary: basics?.summary }),
