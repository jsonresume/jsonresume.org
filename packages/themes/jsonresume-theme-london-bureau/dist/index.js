...
`;
const EducationItem = dt(WorkItem)``;
...
function Resume({ resume }) {
  ...
  return /* @__PURE__ */ jsxs(Layout, { children: [
    ...
    work.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      work.map((job, index) => /* @__PURE__ */ jsxs(WorkItem, { children: [
        /* @__PURE__ */ jsxs(ItemHeader, { children: [
          ...
          /* @__PURE__ */ jsx(ItemDate, { children: /* @__PURE__ */ jsx(DateRange, { startDate: job.startDate, endDate: job.endDate }) })
        ] }),
        job.name && /* @__PURE__ */ jsx(ItemSubtitle, { children: job.name }),
        job.location && /* @__PURE__ */ jsx(ItemLocation, { children: job.location }),
    ...
    education.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      education.map((edu, index) => /* @__PURE__ */ jsxs(EducationItem, { children: [
        /* @__PURE__ */ jsxs(ItemHeader, { children: [
          ...
          /* @__PURE__ */ jsx(ItemDate, { children: /* @__PURE__ */ jsx(DateRange, { startDate: edu.startDate, endDate: edu.endDate }) })
        ] }),
    ...
    skills.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      /* @__PURE__ */ jsx(SkillsContainer, { children: skills.map((skill, index) => /* @__PURE__ */ jsxs(SkillCategory, { children: [
    ...
    projects.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      projects.map((project, index) => /* @__PURE__ */ jsxs(ProjectItem, { children: [
        /* @__PURE__ */ jsxs(ItemHeader, { children: [
          ...
          /* @__PURE__ */ jsx(ItemDate, { children: /* @__PURE__ */ jsx(
            DateRange,
            {
        ...
        project.type && /* @__PURE__ */ jsx(ItemLocation, { children: project.type }),
    ...
    awards.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      awards.map((award, index) => /* @__PURE__ */ jsxs(SimpleCard, { children: [
    ...
    publications.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      publications.map((pub, index) => /* @__PURE__ */ jsxs(SimpleCard, { children: [
    ...
    volunteer.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      volunteer.map((vol, index) => /* @__PURE__ */ jsxs(WorkItem, { children: [
        /* @__PURE__ */ jsxs(ItemHeader, { children: [
          ...
          /* @__PURE__ */ jsx(ItemDate, { children: /* @__PURE__ */ jsx(DateRange, { startDate: vol.startDate, endDate: vol.endDate }) })
        ] }),
    ...
    interests.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      interests.map((interest, index) => /* @__PURE__ */ jsxs(SimpleCard, { children: [
    ...
    references.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      references.map((ref, index) => /* @__PURE__ */ jsxs(SimpleCard, { children: [
