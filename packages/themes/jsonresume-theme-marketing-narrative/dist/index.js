...
function WorkSection({ work }) {
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Professional Story" }),
    work.map((job, index) => /* @__PURE__ */ jsxs(StoryItem, { children: [
      /* @__PURE__ */ jsxs(StoryHeader, { children: [
        /* @__PURE__ */ jsx(Position, { children: job.position }),
        /* @__PURE__ */ jsxs(CompanyAndDate, { children: [
      ...
      job.summary && /* @__PURE__ */ jsx(Narrative, { children: job.summary }),
      job.highlights?.length > 0 && /* @__PURE__ */ jsx(Achievements, { children: job.highlights.map((highlight, i) => /* @__PURE__ */ jsx(AchievementItem, { children: highlight }, i)) })
    ] }, index))
  ] });
}
function SkillsSection({ skills }) {
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Toolkit" }),
...
function ProjectsSection({ projects }) {
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Featured Campaigns & Projects" }),
    projects.map((project, index) => /* @__PURE__ */ jsxs(StoryItem, { children: [
      /* @__PURE__ */ jsx(Position, { children: project.name }),
      project.description && /* @__PURE__ */ jsx(Narrative, { children: project.description }),
      project.highlights?.length > 0 && /* @__PURE__ */ jsx(Achievements, { children: project.highlights.map((highlight, i) => /* @__PURE__ */ jsx(AchievementItem, { children: highlight }, i)) })
    ] }, index))
  ] });
}
...
function VolunteerSection({ volunteer }) {
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Community Impact" }),
    volunteer.map((vol, index) => /* @__PURE__ */ jsxs(StoryItem, { children: [
      /* @__PURE__ */ jsxs(StoryHeader, { children: [
      ...
      vol.summary && /* @__PURE__ */ jsx(Narrative, { children: vol.summary }),
      vol.highlights?.length > 0 && /* @__PURE__ */ jsx(Achievements, { children: vol.highlights.map((highlight, i) => /* @__PURE__ */ jsx(AchievementItem, { children: highlight }, i)) })
    ] }, index))
  ] });
}
function AwardsSection({ awards }) {
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Recognition" }),
    awards.map((award, index) => /* @__PURE__ */ jsxs(EducationItem, { children: [
      ...
      award.summary && /* @__PURE__ */ jsx(Narrative, { children: award.summary })
    ] }, index))
  ] });
}
function PublicationsSection({ publications }) {
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Published Work" }),
    publications.map((pub, index) => /* @__PURE__ */ jsxs(EducationItem, { children: [
      ...
      pub.summary && /* @__PURE__ */ jsx(Narrative, { children: pub.summary })
    ] }, index))
  ] });
}
...
function InterestsSection({ interests }) {
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Interests & Passions" }),
...
function ReferencesSection({ references }) {
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    ...
    references.map((ref, index) => /* @__PURE__ */ jsxs("div", { style: { marginBottom: "30px" }, children: [
      /* @__PURE__ */ jsx(Institution, { children: ref.name }),
      ref.reference && /* @__PURE__ */ jsxs(QuoteBlock, { children: [
        '"',
        ref.reference,
        '"'
      ] })
...
const DateText = dt.div`
  ...
  white-space: nowrap;
`;
const Narrative = dt.div`
  font-size: 16px;
  line-height: 2;
  color: #4b5563;
  margin: 20px 0;
`;
const Achievements = dt.div`
  margin: 20px 0 0 0;
`;
const AchievementItem = dt.div`
  margin: 16px 0;
  padding-left: 24px;
  position: relative;
  color: #374151;
...
const SkillTags = dt.div`
  ...
  line-height: 1.8;
`;
const QuoteBlock = dt.blockquote`
  font-size: 17px;
  line-height: 2;
  color: #4b5563;
  font-style: italic;
