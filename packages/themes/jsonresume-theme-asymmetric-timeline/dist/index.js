...
const Summary = dt.p`
  ...
  font-weight: 300;
`;
const TimelineSection = dt(Section)`
  position: relative;
  padding-left: 0;
  padding-top: 40px;
...
const StyledSectionTitle = dt(SectionTitle)`
  ...
  text-align: center;
`;
const GridSection = dt(Section)`
  margin-top: 50px;
`;
const SimpleSection = dt(Section)`
  margin-top: 40px;
`;
const TimelineItem = dt.div`
  position: relative;
  margin-bottom: 60px;
  display: flex;
...
const Subtitle = dt.div`
  ...
  margin-bottom: 6px;
`;
const SkillsGridContainer = dt.div`
  display: grid;
  grid-template-columns: repeat(auto-fill, minmax(250px, 1fr));
  gap: 20px;
`;
...
function Resume({ resume }) {
  ...
  return /* @__PURE__ */ jsxs(Layout, { children: [
    ...
    work?.length > 0 && /* @__PURE__ */ jsxs(TimelineSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Experience" }),
      work.map((job, index) => /* @__PURE__ */ jsx(TimelineItem, { $isLeft: index % 2 === 0, children: /* @__PURE__ */ jsxs(TimelineContent, { children: [
        ...
        job.summary && /* @__PURE__ */ jsx(ItemSummary, { children: job.summary }),
    ...
    education?.length > 0 && /* @__PURE__ */ jsxs(TimelineSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Education" }),
      education.map((edu, index) => /* @__PURE__ */ jsx(TimelineItem, { $isLeft: index % 2 === 0, children: /* @__PURE__ */ jsxs(TimelineContent, { children: [
        /* @__PURE__ */ jsx(Position, { children: edu.institution }),
        ...
        /* @__PURE__ */ jsx(DateText, { children: /* @__PURE__ */ jsx(DateRange, { startDate: edu.startDate, endDate: edu.endDate }) }),
        edu.summary && /* @__PURE__ */ jsx(ItemSummary, { children: edu.summary }),
        edu.highlights?.length > 0 && /* @__PURE__ */ jsx(Highlights, { children: edu.highlights.map((highlight, i) => /* @__PURE__ */ jsx("li", { children: highlight }, i)) })
      ] }) }, index))
    ] }),
    projects?.length > 0 && /* @__PURE__ */ jsxs(SimpleSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Projects" }),
      projects.map((project, index) => /* @__PURE__ */ jsxs(SimpleItem, { children: [
        /* @__PURE__ */ jsx(SimpleTitle, { children: project.name }),
        project.summary && /* @__PURE__ */ jsx(ItemSummary, { children: project.summary }),
        project.description && /* @__PURE__ */ jsx(ItemSummary, { children: project.description }),
    ...
    skills?.length > 0 && /* @__PURE__ */ jsxs(GridSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Skills" }),
      /* @__PURE__ */ jsx(SkillsGridContainer, { children: skills.map((skill, index) => /* @__PURE__ */ jsxs(SkillCategory, { children: [
        /* @__PURE__ */ jsx(SkillName, { children: skill.name }),
        skill.keywords?.length > 0 && /* @__PURE__ */ jsx(SkillTags, { children: skill.keywords.join(", ") })
      ] }, index)) })
    ] }),
    volunteer?.length > 0 && /* @__PURE__ */ jsxs(SimpleSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Volunteer" }),
      volunteer.map((vol, index) => /* @__PURE__ */ jsxs(SimpleItem, { children: [
        /* @__PURE__ */ jsx(SimpleTitle, { children: vol.position }),
        vol.organization && /* @__PURE__ */ jsx(Subtitle, { children: vol.organization }),
        ...
        vol.summary && /* @__PURE__ */ jsx(ItemSummary, { children: vol.summary }),
    ...
    awards?.length > 0 && /* @__PURE__ */ jsxs(SimpleSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Awards" }),
      awards.map((award, index) => /* @__PURE__ */ jsxs(SimpleItem, { children: [
        /* @__PURE__ */ jsx(SimpleTitle, { children: award.title }),
        award.awarder && /* @__PURE__ */ jsxs(Subtitle, { children: [
          "Awarded by ",
          award.awarder
        ] }),
    ...
    publications?.length > 0 && /* @__PURE__ */ jsxs(SimpleSection, { children: [
      ...
      publications.map((pub, index) => /* @__PURE__ */ jsxs(SimpleItem, { children: [
        /* @__PURE__ */ jsx(SimpleTitle, { children: pub.name }),
        pub.publisher && /* @__PURE__ */ jsxs(Subtitle, { children: [
          "Published by ",
          pub.publisher
        ] }),
        pub.releaseDate && /* @__PURE__ */ jsx(DateText, { children: pub.releaseDate }),
        pub.summary && /* @__PURE__ */ jsx(ItemSummary, { children: pub.summary })
      ] }, index))
    ] }),
    languages?.length > 0 && /* @__PURE__ */ jsxs(GridSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Languages" }),
      /* @__PURE__ */ jsx(SkillsGridContainer, { children: languages.map((language, index) => /* @__PURE__ */ jsxs(SkillCategory, { children: [
        /* @__PURE__ */ jsx(SkillName, { children: language.language }),
        language.fluency && /* @__PURE__ */ jsx(SkillTags, { children: language.fluency })
      ] }, index)) })
    ] }),
    interests?.length > 0 && /* @__PURE__ */ jsxs(GridSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Interests" }),
      /* @__PURE__ */ jsx(SkillsGridContainer, { children: interests.map((interest, index) => /* @__PURE__ */ jsxs(SkillCategory, { children: [
    ...
    references?.length > 0 && /* @__PURE__ */ jsxs(SimpleSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "References" }),
      references.map((ref, index) => /* @__PURE__ */ jsxs(SimpleItem, { children: [
        /* @__PURE__ */ jsx(SimpleTitle, { children: ref.name }),
        ref.reference && /* @__PURE__ */ jsx(ItemSummary, { children: ref.reference })
      ] }, index))
    ] })
  ] });
}
