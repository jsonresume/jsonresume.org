...
const WorkCompany = dt.div`
  ...
  margin-bottom: 10px;
`;
const WorkDate = dt.div`
  font-size: 10pt;
  color: #666;
  white-space: nowrap;
  text-align: right;
`;
const WorkDescription = dt.ul`
  margin: 10px 0 0 0;
  padding-left: 20px;
  color: #4a4a4a;
...
`;
const ReferenceGrid = dt.div`
  display: grid;
  grid-template-columns: 1fr 1fr;
  gap: 30px;
`;
const ReferenceCard = dt.div`
  h3 {
    font-size: 12pt;
    font-weight: 700;
    margin: 0 0 5px 0;
...
function Resume({ resume }) {
  ...
  return /* @__PURE__ */ jsxs(Layout, { children: [
    /* @__PURE__ */ jsxs(Sidebar, { children: [
      basics.image && /* @__PURE__ */ jsx(ProfilePhoto, { children: /* @__PURE__ */ jsx("img", { src: basics.image, alt: basics.name }) }),
      (basics.phone || basics.email || basics.location || basics.url) && /* @__PURE__ */ jsxs(SidebarSection, { children: [
        /* @__PURE__ */ jsx(SidebarTitle, { children: "CONTACT" }),
        basics.phone && /* @__PURE__ */ jsxs(ContactItem, { children: [
          /* @__PURE__ */ jsx(Icon, { children: "📞" }),
          /* @__PURE__ */ jsx("span", { children: basics.phone })
        ] }),
        basics.email && /* @__PURE__ */ jsxs(ContactItem, { children: [
          /* @__PURE__ */ jsx(Icon, { children: "✉️" }),
      ...
      education.length > 0 && /* @__PURE__ */ jsxs(SidebarSection, { children: [
        /* @__PURE__ */ jsx(SidebarTitle, { children: "EDUCATION" }),
        education.map((edu, index2) => /* @__PURE__ */ jsxs(EducationItem, { children: [
          /* @__PURE__ */ jsx("div", { className: "dates", children: edu.startDate && edu.endDate ? `${new Date(edu.startDate).getFullYear()} - ${new Date(
            edu.endDate
          ).getFullYear()}` : "" }),
          /* @__PURE__ */ jsx("h3", { children: edu.institution }),
          edu.studyType && edu.area && /* @__PURE__ */ jsxs("ul", { children: [
            /* @__PURE__ */ jsxs("li", { children: [
              edu.studyType,
              " of ",
              edu.area
            ] }),
            edu.score && /* @__PURE__ */ jsxs("li", { children: [
              "GPA: ",
              edu.score
            ] })
          ] })
      ...
      skills.length > 0 && /* @__PURE__ */ jsxs(SidebarSection, { children: [
        /* @__PURE__ */ jsx(SidebarTitle, { children: "SKILLS" }),
        /* @__PURE__ */ jsx(SkillsList, { children: skills.flatMap(
          (skillGroup) => (skillGroup.keywords || []).map((skill, idx) => /* @__PURE__ */ jsx("li", { children: skill }, `${skillGroup.name}-${idx}`))
        ) })
      ] }),
      languages.length > 0 && /* @__PURE__ */ jsxs(SidebarSection, { children: [
        /* @__PURE__ */ jsx(SidebarTitle, { children: "LANGUAGES" }),
        /* @__PURE__ */ jsx(LanguagesList, { children: languages.map((lang, index2) => /* @__PURE__ */ jsxs("li", { children: [
          lang.language,
    ...
    /* @__PURE__ */ jsxs(MainContent, { children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsxs(Name, { children: [
          firstName && /* @__PURE__ */ jsxs("span", { children: [
            firstName,
            " "
          ] }),
          lastName
        ] }),
        basics.label && /* @__PURE__ */ jsx(JobTitle, { children: basics.label })
      ] }),
      basics.summary && /* @__PURE__ */ jsxs(MainSection, { children: [
        /* @__PURE__ */ jsx(MainSectionTitle, { children: "PROFILE" }),
        /* @__PURE__ */ jsx(ProfileText, { children: basics.summary })
      ] }),
      work.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
        /* @__PURE__ */ jsx(MainSectionTitle, { children: "WORK EXPERIENCE" }),
        work.map((job, index2) => /* @__PURE__ */ jsxs(WorkItem, { children: [
          /* @__PURE__ */ jsxs(WorkHeader, { children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(WorkTitle, { children: job.name }),
              /* @__PURE__ */ jsx(WorkCompany, { children: job.position })
            ] }),
            /* @__PURE__ */ jsx(WorkDate, { children: job.startDate && /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          job.summary && /* @__PURE__ */ jsx("p", { style: { marginBottom: "10px", color: "#4a4a4a" }, children: job.summary }),
          job.highlights && job.highlights.length > 0 && /* @__PURE__ */ jsx(WorkDescription, { children: job.highlights.map((highlight, idx) => /* @__PURE__ */ jsx("li", { children: highlight }, idx)) })
        ] }, index2))
      ] }),
      projects.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
        ...
        projects.map((project, index2) => /* @__PURE__ */ jsxs(WorkItem, { children: [
          /* @__PURE__ */ jsxs(WorkHeader, { children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(WorkTitle, { children: project.name }),
              project.url && /* @__PURE__ */ jsx(WorkCompany, { children: /* @__PURE__ */ jsx(
                "a",
                {
            ...
            /* @__PURE__ */ jsx(WorkDate, { children: project.startDate && /* @__PURE__ */ jsxs(Fragment, { children: [
              new Date(project.startDate).getFullYear(),
              project.endDate && ` - ${new Date(project.endDate).getFullYear()}`
            ] }) })
          ] }),
          project.description && /* @__PURE__ */ jsx("p", { style: { marginBottom: "10px", color: "#4a4a4a" }, children: project.description }),
      ...
      references.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
        /* @__PURE__ */ jsx(MainSectionTitle, { children: "REFERENCE" }),
        /* @__PURE__ */ jsx(ReferenceGrid, { children: references.map((ref, index2) => /* @__PURE__ */ jsxs(ReferenceCard, { children: [
