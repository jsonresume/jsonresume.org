  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    ...
    work.map((job, index) => /* @__PURE__ */ jsxs(WorkItem, { children: [
      /* @__PURE__ */ jsxs(WorkHeader, { children: [
        ...
        (job.startDate || job.endDate) && /* @__PURE__ */ jsx(DateText, { children: /* @__PURE__ */ jsx(DateRange, { startDate: job.startDate, endDate: job.endDate }) })
      ] }),
...
function SkillsSection({ skills }) {
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Professional Skills" }),
    skills.map((skill, index) => /* @__PURE__ */ jsxs(SkillsList, { children: [
...
function VolunteerSection({ volunteer }) {
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Volunteer Experience" }),
...
function AwardsSection({ awards }) {
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Awards and Honors" }),
    awards.map((award, index) => /* @__PURE__ */ jsxs(SimpleList, { children: [
      /* @__PURE__ */ jsx(ListItemTitle, { children: award.title }),
      award.awarder && /* @__PURE__ */ jsxs(ListItemText, { children: [
        "Awarded by: ",
        award.awarder
      ] }),
      award.date && /* @__PURE__ */ jsxs(ListItemText, { children: [
        "Date: ",
        award.date
      ] }),
      award.summary && /* @__PURE__ */ jsx(ListItemText, { children: award.summary })
    ] }, index))
  ] });
}
function PublicationsSection({ publications }) {
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    ...
    publications.map((pub, index) => /* @__PURE__ */ jsxs(SimpleList, { children: [
      /* @__PURE__ */ jsx(ListItemTitle, { children: pub.name }),
      pub.publisher && /* @__PURE__ */ jsxs(ListItemText, { children: [
        "Publisher: ",
        pub.publisher
      ] }),
      pub.releaseDate && /* @__PURE__ */ jsxs(ListItemText, { children: [
        "Published: ",
        pub.releaseDate
      ] }),
      pub.summary && /* @__PURE__ */ jsx(ListItemText, { children: pub.summary })
    ] }, index))
  ] });
}
function LanguagesSection({ languages }) {
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    ...
    languages.map((lang, index) => /* @__PURE__ */ jsxs(SkillsList, { children: [
      /* @__PURE__ */ jsxs(SkillName, { children: [
        lang.language,
        ":"
      ] }),
...
function InterestsSection({ interests }) {
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Professional Interests" }),
    interests.map((interest, index) => /* @__PURE__ */ jsxs(SkillsList, { children: [
      /* @__PURE__ */ jsx(SkillName, { children: interest.name }),
      interest.keywords?.length > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
        ": ",
        /* @__PURE__ */ jsx(SkillTags, { children: interest.keywords.join(", ") })
      ] })
    ] }, index))
  ] });
}
function ReferencesSection({ references }) {
  ...
  return /* @__PURE__ */ jsxs(Section, { children: [
    ...
    references.map((ref, index) => /* @__PURE__ */ jsxs(SimpleList, { children: [
      /* @__PURE__ */ jsx(ListItemTitle, { children: ref.name }),
      ref.reference && /* @__PURE__ */ jsx(ListItemText, { children: ref.reference })
    ] }, index))
  ] });
}
const Layout = dt.div`
...
function Resume({ resume }) {
  ...
  return /* @__PURE__ */ jsxs(Layout, { children: [
    ...
    basics.summary && /* @__PURE__ */ jsxs(Section, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Professional Summary" }),
      /* @__PURE__ */ jsx(Summary, { children: basics.summary })
    ] }),
