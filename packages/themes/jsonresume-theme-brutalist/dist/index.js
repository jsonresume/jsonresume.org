...
`;
const SpecTag = dt.span`
  background: ${ACCENT};
  font-weight: 700;
`;
const NameBlock = dt.div`
...
const StyledBadge = dt(Badge)`
  ...
  padding: 3px 8px;
`;
const PlainGrid = dt.div`
  display: grid;
  grid-template-columns: repeat(auto-fill, minmax(260px, 1fr));
  gap: 18px;
`;
const PlainCard = dt.div`
  border: ${HAIR};
  border-left: ${RULE};
  padding: 14px 16px;
...
function Resume({ resume }) {
  ...
  let section = 0;
  const next2 = () => pad(++section);
  return /* @__PURE__ */ jsxs(Page, { children: [
    /* @__PURE__ */ jsxs(Masthead, { children: [
      /* @__PURE__ */ jsxs(SpecBar, { children: [
        /* @__PURE__ */ jsx(SpecTag, { children: "Curriculum Vitae" }),
        locLine && /* @__PURE__ */ jsx("span", { children: locLine }),
        /* @__PURE__ */ jsx("span", { children: "Rev. 0.1" })
      ] }),
      /* @__PURE__ */ jsxs(NameBlock, { children: [
        basics.name && /* @__PURE__ */ jsx(Name, { children: basics.name }),
        basics.label && /* @__PURE__ */ jsx(Label, { children: basics.label })
      ] }),
      (basics.email || basics.phone || basics.url || basics.profiles && basics.profiles.length > 0) && /* @__PURE__ */ jsx(ContactRow, { children: /* @__PURE__ */ jsx(StyledContactInfo, { basics }) }),
      basics.summary && /* @__PURE__ */ jsx(Summary, { children: basics.summary })
    ] }),
    /* @__PURE__ */ jsxs(Body, { children: [
      work.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { "data-index": next2(), children: "Experience" }),
        work.map((job, i) => /* @__PURE__ */ jsxs(Entry, { children: [
          /* @__PURE__ */ jsxs(EntryHead, { children: [
            /* @__PURE__ */ jsx(EntryTitle, { children: job.position || job.name || "Role" }),
            (job.startDate || job.endDate) && /* @__PURE__ */ jsx(EntryMeta, { children: /* @__PURE__ */ jsx(
              DateRange,
              {
          ...
          job.name && job.position && /* @__PURE__ */ jsxs(EntrySub, { children: [
            job.url ? /* @__PURE__ */ jsx(Link, { href: safeUrl(job.url), children: job.name }) : job.name,
            job.location ? ` // ${job.location}` : ""
          ] }),
          job.summary && /* @__PURE__ */ jsx(Para, { children: job.summary }),
          job.highlights && job.highlights.length > 0 && /* @__PURE__ */ jsx(Bullets, { children: job.highlights.map((h, hi) => /* @__PURE__ */ jsx("li", { children: h }, hi)) })
        ] }, i))
      ] }),
      education.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { "data-index": next2(), children: "Education" }),
        education.map((edu, i) => /* @__PURE__ */ jsxs(Entry, { children: [
          /* @__PURE__ */ jsxs(EntryHead, { children: [
            /* @__PURE__ */ jsx(EntryTitle, { children: edu.institution || "Institution" }),
            (edu.startDate || edu.endDate) && /* @__PURE__ */ jsx(EntryMeta, { children: /* @__PURE__ */ jsx(
              DateRange,
              {
          ...
          edu.score && /* @__PURE__ */ jsxs(Para, { children: [
            "GPA: ",
            edu.score
          ] }),
          edu.courses && edu.courses.length > 0 && /* @__PURE__ */ jsx(Bullets, { children: edu.courses.map((c, ci) => /* @__PURE__ */ jsx("li", { children: c }, ci)) })
        ] }, i))
      ] }),
      skills.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { "data-index": next2(), children: "Skills" }),
        /* @__PURE__ */ jsx(SkillGrid, { children: skills.map((skill, i) => /* @__PURE__ */ jsxs(SkillCell, { children: [
          /* @__PURE__ */ jsxs("h4", { children: [
            skill.name || "Skills",
            skill.level ? ` — ${skill.level}` : ""
          ] }),
          skill.keywords && skill.keywords.length > 0 && /* @__PURE__ */ jsx(StyledBadgeList, { children: skill.keywords.map((kw, ki) => /* @__PURE__ */ jsx(StyledBadge, { children: kw }, ki)) })
        ] }, i)) })
      ] }),
      projects.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { "data-index": next2(), children: "Projects" }),
        projects.map((project, i) => /* @__PURE__ */ jsxs(Entry, { children: [
          /* @__PURE__ */ jsxs(EntryHead, { children: [
            /* @__PURE__ */ jsx(EntryTitle, { children: project.url ? /* @__PURE__ */ jsx(Link, { href: safeUrl(project.url), children: project.name || "Project" }) : project.name || "Project" }),
            (project.startDate || project.endDate) && /* @__PURE__ */ jsx(EntryMeta, { children: /* @__PURE__ */ jsx(
              DateRange,
              {
          ...
          (project.entity || project.type) && /* @__PURE__ */ jsx(EntrySub, { children: [project.entity, project.type].filter(Boolean).join(" // ") }),
          project.description && /* @__PURE__ */ jsx(Para, { children: project.description }),
          project.highlights && project.highlights.length > 0 && /* @__PURE__ */ jsx(Bullets, { children: project.highlights.map((h, hi) => /* @__PURE__ */ jsx("li", { children: h }, hi)) }),
          project.keywords && project.keywords.length > 0 && /* @__PURE__ */ jsx(StyledBadgeList, { children: project.keywords.map((kw, ki) => /* @__PURE__ */ jsx(StyledBadge, { children: kw }, ki)) })
        ] }, i))
      ] }),
      volunteer.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { "data-index": next2(), children: "Volunteer" }),
        volunteer.map((vol, i) => /* @__PURE__ */ jsxs(Entry, { children: [
          /* @__PURE__ */ jsxs(EntryHead, { children: [
            /* @__PURE__ */ jsx(EntryTitle, { children: vol.position || "Volunteer" }),
            (vol.startDate || vol.endDate) && /* @__PURE__ */ jsx(EntryMeta, { children: /* @__PURE__ */ jsx(
              DateRange,
              {
          ...
          vol.organization && /* @__PURE__ */ jsx(EntrySub, { children: vol.url ? /* @__PURE__ */ jsx(Link, { href: safeUrl(vol.url), children: vol.organization }) : vol.organization }),
          vol.summary && /* @__PURE__ */ jsx(Para, { children: vol.summary }),
          vol.highlights && vol.highlights.length > 0 && /* @__PURE__ */ jsx(Bullets, { children: vol.highlights.map((h, hi) => /* @__PURE__ */ jsx("li", { children: h }, hi)) })
        ] }, i))
      ] }),
      awards.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { "data-index": next2(), children: "Awards" }),
        /* @__PURE__ */ jsx(PlainGrid, { children: awards.map((award, i) => /* @__PURE__ */ jsxs(PlainCard, { children: [
          /* @__PURE__ */ jsx("h4", { children: award.title || "Award" }),
          (award.awarder || award.date) && /* @__PURE__ */ jsx(MetaTag, { children: [award.awarder, award.date].filter(Boolean).join(" // ") }),
          award.summary && /* @__PURE__ */ jsx("p", { children: award.summary })
        ] }, i)) })
      ] }),
      certificates.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { "data-index": next2(), children: "Certificates" }),
        /* @__PURE__ */ jsx(PlainGrid, { children: certificates.map((cert, i) => /* @__PURE__ */ jsxs(PlainCard, { children: [
          /* @__PURE__ */ jsx("h4", { children: cert.url ? /* @__PURE__ */ jsx(Link, { href: safeUrl(cert.url), children: cert.name || "Certificate" }) : cert.name || "Certificate" }),
          (cert.issuer || cert.date) && /* @__PURE__ */ jsx(MetaTag, { children: [cert.issuer, cert.date].filter(Boolean).join(" // ") })
        ] }, i)) })
      ] }),
      publications.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { "data-index": next2(), children: "Publications" }),
        /* @__PURE__ */ jsx(PlainGrid, { children: publications.map((pub, i) => /* @__PURE__ */ jsxs(PlainCard, { children: [
          /* @__PURE__ */ jsx("h4", { children: pub.url ? /* @__PURE__ */ jsx(Link, { href: safeUrl(pub.url), children: pub.name || "Publication" }) : pub.name || "Publication" }),
          (pub.publisher || pub.releaseDate) && /* @__PURE__ */ jsx(MetaTag, { children: [pub.publisher, pub.releaseDate].filter(Boolean).join(" // ") }),
          pub.summary && /* @__PURE__ */ jsx("p", { children: pub.summary })
        ] }, i)) })
      ] }),
      languages.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { "data-index": next2(), children: "Languages" }),
        /* @__PURE__ */ jsx(StyledBadgeList, { children: languages.map((lang, i) => /* @__PURE__ */ jsxs(StyledBadge, { children: [
          lang.language || "Language",
          lang.fluency ? ` — ${lang.fluency}` : ""
        ] }, i)) })
      ] }),
      interests.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { "data-index": next2(), children: "Interests" }),
        /* @__PURE__ */ jsx(PlainGrid, { children: interests.map((interest, i) => /* @__PURE__ */ jsxs(PlainCard, { children: [
          /* @__PURE__ */ jsx("h4", { children: interest.name || "Interest" }),
          interest.keywords && interest.keywords.length > 0 && /* @__PURE__ */ jsx("p", { children: interest.keywords.join(", ") })
        ] }, i)) })
      ] }),
      references.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { "data-index": next2(), children: "References" }),
        /* @__PURE__ */ jsx(PlainGrid, { children: references.map((ref, i) => /* @__PURE__ */ jsxs(PlainCard, { children: [
          /* @__PURE__ */ jsx("h4", { children: ref.name || "Reference" }),
          ref.reference && /* @__PURE__ */ jsx("p", { children: ref.reference })
        ] }, i)) })
      ] })
    ] })
  ] });
