...
const MainSectionTitle = dt(SectionTitle)`
  ...
  min-width: 200px;
`;
const CertificationsGrid = dt.div`
  display: grid;
  grid-template-columns: repeat(auto-fill, minmax(280px, 1fr));
  gap: 20px;
  margin-bottom: 12px;
`;
const CertCard = dt.div`
  padding: 20px;
...
`;
const CertName = dt.h3`
  font-size: 17px;
  font-weight: 700;
  margin: 0 0 8px 0;
  color: #0c4a6e;
`;
const CertIssuer = dt.div`
  font-size: 14px;
  color: #059669;
  font-weight: 600;
  margin-bottom: 6px;
`;
const CertDate = dt.div`
  font-size: 13px;
  color: #64748b;
  font-style: italic;
`;
...
`;
const AwardsList = dt.div`
  display: grid;
  grid-template-columns: repeat(auto-fill, minmax(300px, 1fr));
  gap: 18px;
`;
const AwardCard = dt.div`
  padding: 18px;
...
`;
const PublicationsList = dt.div`
  display: grid;
  gap: 20px;
`;
const PublicationCard = dt.div`
  padding: 20px;
  background: #faf5ff;
...
function Resume({ resume }) {
  ...
  return /* @__PURE__ */ jsxs(Layout, { children: [
    ...
    basics.summary && /* @__PURE__ */ jsx(SummarySection, { children: /* @__PURE__ */ jsxs(SummaryText, { children: [
      '"',
      basics.summary,
      '"'
    ] }) }),
    certificates && certificates.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
      /* @__PURE__ */ jsx(MainSectionTitle, { children: "Certifications & Diplomas" }),
      /* @__PURE__ */ jsx(CertificationsGrid, { children: certificates.map((cert, index) => /* @__PURE__ */ jsxs(CertCard, { children: [
        /* @__PURE__ */ jsx(CertName, { children: cert.name }),
        cert.issuer && /* @__PURE__ */ jsxs(CertIssuer, { children: [
          "Issued by: ",
          cert.issuer
        ] }),
        cert.date && /* @__PURE__ */ jsx(CertDate, { children: cert.date })
      ] }, index)) })
    ] }),
    volunteer.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
      /* @__PURE__ */ jsx(MainSectionTitle, { children: "Community Involvement" }),
      volunteer.map((vol, index) => /* @__PURE__ */ jsxs(VolunteerItem, { children: [
    ...
    work.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
      /* @__PURE__ */ jsx(MainSectionTitle, { children: "Professional Experience" }),
    ...
    skills.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
      ...
      /* @__PURE__ */ jsx(SkillsGrid, { children: skills.map((skill, index) => /* @__PURE__ */ jsxs(SkillCard, { children: [
        /* @__PURE__ */ jsx(SkillName, { children: skill.name }),
        skill.keywords && skill.keywords.length > 0 && /* @__PURE__ */ jsx(SkillKeywords, { children: skill.keywords.map((keyword, i) => /* @__PURE__ */ jsx(SkillBadge, { children: keyword }, i)) })
      ] }, index)) })
    ] }),
    ...
    awards.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
      /* @__PURE__ */ jsx(MainSectionTitle, { children: "Awards & Recognition" }),
      /* @__PURE__ */ jsx(AwardsList, { children: awards.map((award, index) => /* @__PURE__ */ jsxs(AwardCard, { children: [
        /* @__PURE__ */ jsx("strong", { children: award.title }),
        award.awarder && /* @__PURE__ */ jsxs("div", { style: { marginTop: "8px", color: "#92400e" }, children: [
          "— ",
          award.awarder
        ] }),
    ...
    publications.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
      ...
      /* @__PURE__ */ jsx(PublicationsList, { children: publications.map((pub, index) => /* @__PURE__ */ jsxs(PublicationCard, { children: [
        /* @__PURE__ */ jsx("strong", { children: pub.name }),
        pub.publisher && /* @__PURE__ */ jsxs("div", { style: { marginTop: "8px", color: "#5b21b6" }, children: [
          "— ",
          pub.publisher
        ] }),
    ...
    languages.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
      ...
      /* @__PURE__ */ jsx(SimpleList, { children: languages.map((lang, index) => /* @__PURE__ */ jsxs(SimpleCard, { children: [
    ...
    interests.length > 0 && /* @__PURE__ */ jsxs(MainSection, { children: [
      ...
      /* @__PURE__ */ jsx(SimpleList, { children: interests.map((interest, index) => /* @__PURE__ */ jsxs(SimpleCard, { children: [
        ...
        interest.keywords && interest.keywords.length > 0 && /* @__PURE__ */ jsx(SkillKeywords, { style: { marginTop: "10px" }, children: interest.keywords.map((keyword, i) => /* @__PURE__ */ jsx(SkillBadge, { children: keyword }, i)) })
      ] }, index)) })
    ] }),
...
function render(resume) {
  ...
  return renderResumeDocument(/* @__PURE__ */ jsx(Resume, { resume }), {
    fonts: ["Quicksand:wght@400;500;600;700", "Nunito:wght@400;600;700"],
    title,
