...
`;
const SectionHeading = dt(SectionTitle)`
  display: inline-flex;
  align-items: center;
  gap: 12px;
  font-size: 15px;
...
const EntryMeta = dt.div`
  ...
  white-space: nowrap;
`;
const EntrySummary = dt.p`
  margin: 0;
  color: #4f3d31;
  line-height: 1.75;
  font-size: 14px;
`;
const BulletList = dt.ul`
  margin: 0;
  padding: 0;
  list-style: none;
  display: grid;
...
const SkillGrid = dt.div`
  ...
  grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));
`;
const SkillCard = dt.div`
  display: flex;
  flex-direction: column;
  gap: 8px;
`;
const SkillTitle = dt.div`
  font-size: 15px;
  font-weight: 600;
  color: #4a3326;
`;
...
const renderHighlights = (items) => items?.length ? /* @__PURE__ */ jsx(BulletList, { children: items.map((text, index) => /* @__PURE__ */ jsx("li", { children: text }, index)) }) : null;
function Resume({ resume }) {
  ...
  return /* @__PURE__ */ jsxs(Layout, { children: [
    ...
    work?.length > 0 && /* @__PURE__ */ jsxs(SectionBlock, { children: [
      /* @__PURE__ */ jsx(SectionHeading, { children: "Experience" }),
      work.map((job, index) => /* @__PURE__ */ jsxs(Entry, { children: [
        /* @__PURE__ */ jsxs(EntryHeader, { children: [
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            job.name || job.location ? /* @__PURE__ */ jsx(EntrySubtitle, { children: joinParts(job.name, job.location) }) : null
          ] }),
        ...
        job.summary && /* @__PURE__ */ jsx(EntrySummary, { children: job.summary }),
        renderHighlights(job.highlights)
      ] }, index))
    ] }),
    projects?.length > 0 && /* @__PURE__ */ jsxs(SectionBlock, { children: [
      /* @__PURE__ */ jsx(SectionHeading, { children: "Projects" }),
        ...
        return /* @__PURE__ */ jsxs(Entry, { children: [
          /* @__PURE__ */ jsxs(EntryHeader, { children: [
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              (descriptor || project.url) && /* @__PURE__ */ jsxs(EntrySubtitle, { children: [
                descriptor,
                descriptor && project.url ? " • " : "",
                project.url && /* @__PURE__ */ jsx(Anchor, { href: project.url, children: project.url })
              ] })
            ] }),
          ...
          summary && /* @__PURE__ */ jsx(EntrySummary, { children: summary }),
          renderHighlights(project.highlights),
          project.keywords?.length > 0 && /* @__PURE__ */ jsx(KeywordList, { children: project.keywords.join(" • ") })
        ] }, index);
      })
    ] }),
    education?.length > 0 && /* @__PURE__ */ jsxs(SectionBlock, { children: [
      /* @__PURE__ */ jsx(SectionHeading, { children: "Education" }),
      education.map((edu, index) => /* @__PURE__ */ jsxs(Entry, { children: [
        /* @__PURE__ */ jsxs(EntryHeader, { children: [
          /* @__PURE__ */ jsxs("div", { children: [
            edu.institution && /* @__PURE__ */ jsx(EntryTitle, { children: edu.institution }),
            (edu.studyType || edu.area || edu.score) && /* @__PURE__ */ jsx(EntrySubtitle, { children: joinParts(
        ...
        edu.courses?.length > 0 && /* @__PURE__ */ jsxs(KeywordList, { children: [
          "Key courses: ",
          edu.courses.join(", ")
        ] })
      ] }, index))
    ] }),
    skills?.length > 0 && /* @__PURE__ */ jsxs(SectionBlock, { children: [
      /* @__PURE__ */ jsx(SectionHeading, { children: "Skills" }),
      /* @__PURE__ */ jsx(SkillGrid, { children: skills.map((skill, index) => /* @__PURE__ */ jsxs(SkillCard, { children: [
        /* @__PURE__ */ jsxs(SkillTitle, { children: [
          skill.name,
          skill.level && /* @__PURE__ */ jsx(Pill, { children: skill.level })
        ] }),
        skill.keywords?.length > 0 && /* @__PURE__ */ jsx(KeywordList, { children: skill.keywords.join(" • ") })
      ] }, index)) })
    ] }),
    volunteer?.length > 0 && /* @__PURE__ */ jsxs(SectionBlock, { children: [
      /* @__PURE__ */ jsx(SectionHeading, { children: "Volunteer" }),
      volunteer.map((item, index) => /* @__PURE__ */ jsxs(Entry, { children: [
        /* @__PURE__ */ jsxs(EntryHeader, { children: [
          /* @__PURE__ */ jsxs("div", { children: [
            item.position && /* @__PURE__ */ jsx(EntryTitle, { children: item.position }),
            (item.organization || item.location) && /* @__PURE__ */ jsx(EntrySubtitle, { children: joinParts(item.organization, item.location) })
          ] }),
          (item.startDate || item.endDate) && /* @__PURE__ */ jsx(EntryMeta, { children: /* @__PURE__ */ jsx(
            DateRange,
            {
        ...
        item.summary && /* @__PURE__ */ jsx(EntrySummary, { children: item.summary }),
        renderHighlights(item.highlights)
      ] }, index))
    ] }),
    awards?.length > 0 && /* @__PURE__ */ jsxs(SectionBlock, { children: [
      /* @__PURE__ */ jsx(SectionHeading, { children: "Awards" }),
      awards.map((award, index) => /* @__PURE__ */ jsxs(Entry, { children: [
        /* @__PURE__ */ jsxs(EntryHeader, { children: [
          /* @__PURE__ */ jsxs("div", { children: [
            award.title && /* @__PURE__ */ jsx(EntryTitle, { children: award.title }),
            award.awarder && /* @__PURE__ */ jsxs(EntrySubtitle, { children: [
              "Issued by ",
              award.awarder
            ] })
          ] }),
          award.date && /* @__PURE__ */ jsx(EntryMeta, { children: award.date })
        ] }),
        award.summary && /* @__PURE__ */ jsx(EntrySummary, { children: award.summary })
      ] }, index))
    ] }),
    certificates?.length > 0 && /* @__PURE__ */ jsxs(SectionBlock, { children: [
      /* @__PURE__ */ jsx(SectionHeading, { children: "Certifications" }),
      certificates.map((cert, index) => /* @__PURE__ */ jsxs(Entry, { children: [
        /* @__PURE__ */ jsxs(EntryHeader, { children: [
          /* @__PURE__ */ jsxs("div", { children: [
            cert.name && /* @__PURE__ */ jsx(EntryTitle, { children: cert.name }),
            cert.issuer && /* @__PURE__ */ jsxs(EntrySubtitle, { children: [
              "Issued by ",
              cert.issuer
            ] })
          ] }),
          cert.date && /* @__PURE__ */ jsx(EntryMeta, { children: cert.date })
        ] }),
        cert.summary && /* @__PURE__ */ jsx(EntrySummary, { children: cert.summary }),
        cert.url && /* @__PURE__ */ jsx(KeywordList, { children: /* @__PURE__ */ jsx(Anchor, { href: cert.url, children: cert.url }) })
      ] }, index))
    ] }),
    publications?.length > 0 && /* @__PURE__ */ jsxs(SectionBlock, { children: [
      /* @__PURE__ */ jsx(SectionHeading, { children: "Publications" }),
      publications.map((pub, index) => /* @__PURE__ */ jsxs(Entry, { children: [
        /* @__PURE__ */ jsxs(EntryHeader, { children: [
          /* @__PURE__ */ jsxs("div", { children: [
            pub.name && /* @__PURE__ */ jsx(EntryTitle, { children: pub.name }),
            (pub.publisher || pub.url) && /* @__PURE__ */ jsxs(EntrySubtitle, { children: [
              pub.publisher,
              pub.publisher && pub.url ? " • " : "",
              pub.url && /* @__PURE__ */ jsx(Anchor, { href: pub.url, children: pub.url })
            ] })
          ] }),
          pub.releaseDate && /* @__PURE__ */ jsx(EntryMeta, { children: pub.releaseDate })
        ] }),
        pub.summary && /* @__PURE__ */ jsx(EntrySummary, { children: pub.summary })
      ] }, index))
    ] }),
    languages?.length > 0 && /* @__PURE__ */ jsxs(SectionBlock, { children: [
      /* @__PURE__ */ jsx(SectionHeading, { children: "Languages" }),
      /* @__PURE__ */ jsx(SkillGrid, { children: languages.map((lang, index) => /* @__PURE__ */ jsxs(SkillCard, { children: [
        /* @__PURE__ */ jsx(SkillTitle, { children: lang.language }),
        lang.fluency && /* @__PURE__ */ jsx(Pill, { children: lang.fluency })
      ] }, index)) })
    ] }),
    interests?.length > 0 && /* @__PURE__ */ jsxs(SectionBlock, { children: [
      /* @__PURE__ */ jsx(SectionHeading, { children: "Interests" }),
      /* @__PURE__ */ jsx(SkillGrid, { children: interests.map((interest, index) => /* @__PURE__ */ jsxs(SkillCard, { children: [
        /* @__PURE__ */ jsx(SkillTitle, { children: interest.name }),
        interest.keywords?.length > 0 && /* @__PURE__ */ jsx(KeywordList, { children: interest.keywords.join(" • ") })
      ] }, index)) })
    ] }),
    references?.length > 0 && /* @__PURE__ */ jsxs(SectionBlock, { children: [
      /* @__PURE__ */ jsx(SectionHeading, { children: "References" }),
      references.map((ref, index) => /* @__PURE__ */ jsxs(Entry, { children: [
        ref.name && /* @__PURE__ */ jsx(EntryTitle, { children: ref.name }),
        ref.reference && /* @__PURE__ */ jsx(EntrySummary, { children: ref.reference })
      ] }, index))
    ] })
  ] });
}
