...
function SectionRule({ children, withTop = false }) {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    withTop && /* @__PURE__ */ jsx(MastChevron, { "aria-hidden": "true" }),
    /* @__PURE__ */ jsxs(HeadingRule, { children: [
      /* @__PURE__ */ jsx(Sunburst, { "aria-hidden": "true" }),
      children,
      /* @__PURE__ */ jsx(Chevron, { "aria-hidden": "true" })
    ] })
  ] });
}
function Resume({ resume }) {
  ...
  return /* @__PURE__ */ jsxs(Page, { children: [
    /* @__PURE__ */ jsxs(Masthead, { children: [
      /* @__PURE__ */ jsx(TopRule, { children: "Curriculum Vitae" }),
      basics.name && /* @__PURE__ */ jsx(Name, { children: basics.name }),
      basics.label && /* @__PURE__ */ jsx(Label, { children: basics.label }),
      /* @__PURE__ */ jsx(MastChevron, { "aria-hidden": "true" }),
      (basics.email || basics.phone || basics.url || basics.profiles && basics.profiles.length > 0) && /* @__PURE__ */ jsx(StyledContactInfo, { basics, separator: "◆" })
    ] }),
    /* @__PURE__ */ jsxs(Body, { children: [
      basics.summary && /* @__PURE__ */ jsx(Summary, { children: basics.summary }),
      work.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { children: "Experience" }),
        ...
        work.map((job, i) => /* @__PURE__ */ jsxs(Entry, { children: [
          /* @__PURE__ */ jsxs(EntryHead, { children: [
            ...
            job.name && job.position && /* @__PURE__ */ jsx(EntrySub, { children: job.url ? /* @__PURE__ */ jsx(Link, { href: safeUrl(job.url), children: job.name }) : job.name }),
            (job.startDate || job.endDate || job.location) && /* @__PURE__ */ jsxs(EntryMeta, { children: [
              (job.startDate || job.endDate) && /* @__PURE__ */ jsx(
                DateRange,
                {
      ...
      education.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { children: "Education" }),
        /* @__PURE__ */ jsx(SectionRule, {}),
      ...
      skills.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { children: "Skills" }),
        /* @__PURE__ */ jsx(SectionRule, {}),
        /* @__PURE__ */ jsx(SkillsWrap, { children: skills.map((skill, i) => /* @__PURE__ */ jsxs(SkillGroup, { children: [
      ...
      projects.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { children: "Projects" }),
        /* @__PURE__ */ jsx(SectionRule, {}),
      ...
      volunteer.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { children: "Volunteer" }),
        /* @__PURE__ */ jsx(SectionRule, {}),
      ...
      awards.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { children: "Awards" }),
        /* @__PURE__ */ jsx(SectionRule, {}),
        /* @__PURE__ */ jsx(Cards, { children: awards.map((award, i) => /* @__PURE__ */ jsxs(Card, { children: [
          /* @__PURE__ */ jsx("h4", { children: award.title || "Award" }),
          (award.awarder || award.date) && /* @__PURE__ */ jsx(CardMeta, { children: [award.awarder, award.date].filter(Boolean).join(" · ") }),
          award.summary && /* @__PURE__ */ jsx("p", { children: award.summary })
        ] }, i)) })
      ] }),
      certificates.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { children: "Certificates" }),
        /* @__PURE__ */ jsx(SectionRule, {}),
        /* @__PURE__ */ jsx(Cards, { children: certificates.map((cert, i) => /* @__PURE__ */ jsxs(Card, { children: [
          ...
          (cert.issuer || cert.date) && /* @__PURE__ */ jsx(CardMeta, { children: [cert.issuer, cert.date].filter(Boolean).join(" · ") })
        ] }, i)) })
      ] }),
      publications.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { children: "Publications" }),
        /* @__PURE__ */ jsx(SectionRule, {}),
        /* @__PURE__ */ jsx(Cards, { children: publications.map((pub, i) => /* @__PURE__ */ jsxs(Card, { children: [
          ...
          (pub.publisher || pub.releaseDate) && /* @__PURE__ */ jsx(CardMeta, { children: [pub.publisher, pub.releaseDate].filter(Boolean).join(" · ") }),
          pub.summary && /* @__PURE__ */ jsx("p", { children: pub.summary })
        ] }, i)) })
      ] }),
      languages.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { children: "Languages" }),
        /* @__PURE__ */ jsx(SectionRule, {}),
      ...
      interests.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { children: "Interests" }),
        /* @__PURE__ */ jsx(SectionRule, {}),
        /* @__PURE__ */ jsx(Cards, { children: interests.map((interest, i) => /* @__PURE__ */ jsxs(Card, { children: [
      ...
      references.length > 0 && /* @__PURE__ */ jsxs(Block, { children: [
        /* @__PURE__ */ jsx(Heading, { children: "References" }),
        /* @__PURE__ */ jsx(SectionRule, {}),
        /* @__PURE__ */ jsx(Cards, { children: references.map((ref, i) => /* @__PURE__ */ jsxs(Card, { children: [
