...
`;
const CompactItem = dt.div`
  font-size: 16px;
  line-height: 1.7;
  color: #3a3a3a;
`;
const CompactTitle = dt.span`
  font-weight: 700;
  color: #2f2f2f;
`;
function Resume({ resume }) {
  ...
  return /* @__PURE__ */ jsxs(Layout, { children: [
    ...
    skills?.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Skills & Expertise" }),
      /* @__PURE__ */ jsx(SkillsContainer, { children: skills.map((skill, index2) => /* @__PURE__ */ jsxs(SkillItem, { children: [
        /* @__PURE__ */ jsx(SkillName, { children: skill.name }),
        /* @__PURE__ */ jsx(SkillKeywords, { children: skill.keywords?.length > 0 ? skill.keywords.join(" · ") : "—" })
      ] }, index2)) })
    ] }),
    ...
    projects?.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      projects.map((project, index2) => /* @__PURE__ */ jsxs(ProjectItem, { children: [
        /* @__PURE__ */ jsxs(ProjectHeader, { children: [
          /* @__PURE__ */ jsx(ProjectName, { children: project.name }),
    ...
    awards?.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      /* @__PURE__ */ jsx(StyledSectionTitle, { children: "Awards & Recognition" }),
    ...
    languages?.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      /* @__PURE__ */ jsx(TwoColumnGrid, { children: languages.map((lang, index2) => /* @__PURE__ */ jsxs(CompactItem, { children: [
        /* @__PURE__ */ jsxs(CompactTitle, { children: [
          lang.language,
          ":"
        ] }),
        " ",
    ...
    interests?.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      /* @__PURE__ */ jsx(TwoColumnGrid, { children: interests.map((interest, index2) => /* @__PURE__ */ jsxs(CompactItem, { children: [
        /* @__PURE__ */ jsx(CompactTitle, { children: interest.name }),
    ...
    references?.length > 0 && /* @__PURE__ */ jsxs(StyledSection, { children: [
      ...
      references.map((ref, index2) => /* @__PURE__ */ jsxs(EducationItem, { children: [
        ...
        ref.reference && /* @__PURE__ */ jsxs(WorkSummary, { children: [
          '"',
          ref.reference,
          '"'
        ] })
